...
public class GetSuperPkgMemProdServiceClientImpl extends BaseClientServiceImpl implements IGetSuperPkgMemProdService
{
	public QRY060074Result getSuperChooseProd(String msisdn, String packageId, String mainprodid) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY060074";
		...
		try
		{
			...
			if(__ret instanceof QRY060074Result)
			{
				__result = (QRY060074Result)__ret;
			}
			else
			{
				__result = new QRY060074Result();
