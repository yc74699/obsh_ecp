 ...
 * 2014-7-15
 */
public class QuerConcerTinterestServiceClientImpl extends BaseClientServiceImpl implements IQuerConcerTinterestService
{
	public QRY040077Result queryConcerTinterest(String userid, String startday,String endday) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040077";
		...
		try
		{
			...
			if(__ret instanceof QRY040077Result)
			{
				__result = (QRY040077Result)__ret;
			}
			else
			{
				__result = new QRY040077Result();
