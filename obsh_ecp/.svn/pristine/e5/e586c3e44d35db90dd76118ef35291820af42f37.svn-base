...
public class QueryInterFeePayServiceClientImpl extends BaseClientServiceImpl implements IQueryInterFeePayService
{
	public QRY040019Result queryInterFeePay(String phoneNum, String password, String interType) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040019";
		...
		try
		{
			...
			if(__ret instanceof QRY040019Result)
			{
				__result = (QRY040019Result)__ret;
			}
			else
			{
				__result = new QRY040019Result();
