...
public class AliPay4LanServiceClientImpl extends BaseClientServiceImpl implements IAliPay4LanService
{
	public DEL610039Result aliPay4Lan(String phoneNum, String amount, String unionPaySrl) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "DEL610039";
		...
		RequestParameter __param_unionPaySrl = new RequestParameter("unionPaySrl", unionPaySrl);
		__requestData.getParams().add(__param_unionPaySrl);
		...
		try
		{
			...
			if(__ret instanceof DEL610039Result)
			{
				__result = (DEL610039Result)__ret;
			}
			else
			{
			__result = new DEL610039Result();
