...
public class GetUsrTransTemListServiceClientImpl extends BaseClientServiceImpl implements IGetUsrTransTemListService
{
	public QRY050051Result getUsrTransTemList(String userId, String proId, String fromCity) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY050051";
		...
		try
		{
			...
			if(__ret instanceof QRY050051Result)
			{
				__result = (QRY050051Result)__ret;
			}
			else
			{
				__result = new QRY050051Result();
