...
public class QueryMobileTypeServiceClientImpl extends BaseClientServiceImpl implements IQueryMobileTypeService
{
	public QRY050008Result queryMobileType(String brandId) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY050008";
		...
		try
		{
			...
			if(__ret instanceof QRY050008Result)
			{
				__result = (QRY050008Result)__ret;
			}
			else
			{
				__result = new QRY050008Result();
