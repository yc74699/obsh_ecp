...
public class FamilyProdDelServiceClientImpl extends BaseClientServiceImpl implements IFamilyProdDelService
{

	/**
	 * 家庭V网短号套餐注销,请求报文
	 */
	public DEL610043Result familyProdDel(String familysubsid, String pkgprodid) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "DEL610043";
		...
		try
		{
			...
			if(__ret instanceof DEL610043Result)
			{
				__result = (DEL610043Result)__ret;
			}
			else
			{
				__result = new DEL610043Result();
