...
public class QueryFamilyInfoServiceClientImpl extends BaseClientServiceImpl implements IQueryFamilyInfoService
{
	public QRY200001Result queryFamilyInfoService(String subsid) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY200001";
		...
		try
		{
			...
			if(__ret instanceof QRY200001Result)
			{
				__result = (QRY200001Result)__ret;
			}
			else
			{
				__result = new QRY200001Result();
