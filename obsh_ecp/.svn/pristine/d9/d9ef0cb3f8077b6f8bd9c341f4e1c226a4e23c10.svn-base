...
public class BusinessCheckServiceClientImpl extends BaseClientServiceImpl implements IBusinessCheckService
{
	public QRY090001Result businessCheck(String phoneNum, String checkType, String operateType) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY090001";
		...
		try
		{
			...
			if(__ret instanceof QRY090001Result)
			{
				__result = (QRY090001Result)__ret;
			}
			else
			{
				__result = new QRY090001Result();
