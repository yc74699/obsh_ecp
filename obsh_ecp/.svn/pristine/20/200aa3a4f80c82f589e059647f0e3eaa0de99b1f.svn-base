...
public class QueryqStatusByCardIdServiceClientImpl extends BaseClientServiceImpl implements IQueryqStatusByCardIdService
{
	public QRY050038Result queryStatusByCardId(String certType, String certId) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY050038";
		...
		try
		{
			...
			if(__ret instanceof QRY050038Result)
			{
				__result = (QRY050038Result)__ret;
			}
			else
			{
				__result = new QRY050038Result();
