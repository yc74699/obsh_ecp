 ...
 *
 */
public class TerminalActivityCheckNewClientImpl extends BaseClientServiceImpl implements ITerminalActivityCheckNew
{
	public DEL090004Result iTerminalActivityCheckNew(String salenum, String imeiid, String servnumber, String restype, List<Reward> rewardlist) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "DEL090004";
		...
		try
		{
			...
			if(__ret instanceof DEL090004Result)
			{
				__result = (DEL090004Result)__ret;
			}
			else
			{
			__result = new DEL090004Result();
