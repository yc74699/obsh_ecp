...
import com.xwtech.xwecp.service.logic.client_impl.common.impl.MultiNumBlackListAddServiceClientImpl;
import com.xwtech.xwecp.service.logic.pojo.DEL040061Result;
import com.xwtech.xwecp.service.logic.pojo.BlackListInfo;

public class DEL040061Test {

	private static final Logger logger = Logger.getLogger(DEL040061Test.class);
...
//		初始化ecp客户端片段
		...
		IMultiNumBlackListAddService is = new MultiNumBlackListAddServiceClientImpl();
		...
		DEL040061Result re = is.multiNumBlackListAdd("14", "13913825048","13401979553", blackListInfo);
		if(null != re){
