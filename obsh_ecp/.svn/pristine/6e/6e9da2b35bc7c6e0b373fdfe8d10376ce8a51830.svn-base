...
public class QueryNewSpandProduseServiceClientImpl extends BaseClientServiceImpl implements IQueryNewSpandProduseService
{
	public QRY010019Result queryNewSpandProduse(String subSid, String cycle, Integer qryType, String qrysubsid) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY010019";
		...
		try
		{
			...
			if(__ret instanceof QRY010019Result)
			{
				__result = (QRY010019Result)__ret;
			}
			else
			{
				__result = new QRY010019Result();
