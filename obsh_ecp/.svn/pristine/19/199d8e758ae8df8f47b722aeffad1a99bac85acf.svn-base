...
public class QueryIsFamileyMemberClientImpl extends BaseClientServiceImpl implements IQueryIsFamileyMember
{
	public QRY050056Result queryIsFamileyMember(String msisdn) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY050056";
		...
		try
		{
			...
			if(__ret instanceof QRY050056Result)
			{
				__result = (QRY050056Result)__ret;
			}
			else
			{
				__result = new QRY050056Result();
