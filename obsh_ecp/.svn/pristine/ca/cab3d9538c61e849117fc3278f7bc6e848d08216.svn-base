...
import com.xwtech.xwecp.service.logic.client_impl.common.impl.QrySubsProdAttrServiceServiceClientImpl;
import com.xwtech.xwecp.service.logic.pojo.QRY040085Result;

public class QRY040085Test {
	
	private static final Logger logger = Logger.getLogger(QRY040085Test.class);
	...
	public static void main(String[] args) throws Exception
	{
		...
		IQrySubsProdAttrService co = new QrySubsProdAttrServiceServiceClientImpl();
		QRY040085Result re = co.qrySubsProdAttr("13913814503","");
