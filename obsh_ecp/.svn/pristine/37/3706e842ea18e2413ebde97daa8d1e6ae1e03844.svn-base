...
public class GetPkgInfoServiceClientImpl extends BaseClientServiceImpl implements IGetPkgInfoService
{
	public QRY050053Result getPkgInfo(String city, String rectype, String mobile, String prodId) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY050053";
		...
		try
		{
			...
			if(__ret instanceof QRY050053Result)
			{
				__result = (QRY050053Result)__ret;
			}
			else
			{
				__result = new QRY050053Result();
