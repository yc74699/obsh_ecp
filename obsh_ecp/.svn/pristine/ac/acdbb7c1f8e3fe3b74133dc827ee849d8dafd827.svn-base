...
public class QueryMmsDealNewServiceClientImpl extends BaseClientServiceImpl implements IQueryMmsDealNewService
{
	public QRY090012Result queryMmsDealNew(String phoneNum, int scope, String bossmarket_rec_type) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY090012";
		...
		try
		{
			...
			if(__ret instanceof QRY090012Result)
			{
				__result = (QRY090012Result)__ret;
			}
			else
			{
				__result = new QRY090012Result();
