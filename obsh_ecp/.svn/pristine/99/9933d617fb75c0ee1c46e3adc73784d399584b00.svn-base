...
import com.xwtech.xwecp.service.logic.client_impl.common.IQryReinforceInfoService;
import com.xwtech.xwecp.service.logic.client_impl.common.impl.QryReinforceInfoServiceClientImpl;
import com.xwtech.xwecp.service.logic.pojo.GommonBusiness;
import com.xwtech.xwecp.service.logic.pojo.QRY050055Result;


public class QRY050055Test
{
	private static final Logger logger = Logger.getLogger(QRY050055Test.class);
	...
	public static void main(String[] args) throws Exception
	{
		...
		try{
			IQryReinforceInfoService co = new QryReinforceInfoServiceClientImpl();
		//动感地带 13401312424  brand_id：11 city_id：17 user_id：1738200005062065
		//全球通 13913032424 user_id：1419200008195160
			QRY050055Result re = co.qryreInforceInfo("11108100095826863");
