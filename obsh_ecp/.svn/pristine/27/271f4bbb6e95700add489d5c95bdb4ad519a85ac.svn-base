...
public class QuerySmsPkgUsedInfoServiceClientImpl extends BaseClientServiceImpl implements IQuerySmsPkgUsedInfoService
{
	public QRY040031Result querySmsPkgUsedInfo(String phoneNum) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040031";
		...
		try
		{
			...
			if(__ret instanceof QRY040031Result)
			{
				__result = (QRY040031Result)__ret;
			}
		}
		catch(Exception __e)
		{
