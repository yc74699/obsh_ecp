...
import com.xwtech.xwecp.service.logic.client_impl.common.impl.Change17202ServiceClientImpl;
import com.xwtech.xwecp.service.logic.pojo.DEL040014Result;

public class DEL040014Test
{
	private static final Logger logger = Logger.getLogger(DEL040014Test.class);
	...
	public static void main(String[] args) throws Exception
	{
		...
		IChange17202Service co = new Change17202ServiceClientImpl();
		DEL040014Result re = co.change17202("13913032424", "3006", "4", "1", "168011");
		logger.info(" ====== 开始返回参数 ======");
		if (re != null)
		{
