...
public class QueryUserEPackageServiceClientImpl extends BaseClientServiceImpl implements IQueryUserEPackageService
{
	public QRY040014Result queryUserEPackage(String phoneNum) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040014";
		...
		try
		{
			...
			if(__ret instanceof QRY040014Result)
			{
				__result = (QRY040014Result)__ret;
			}
			else
			{
				__result = new QRY040014Result();
