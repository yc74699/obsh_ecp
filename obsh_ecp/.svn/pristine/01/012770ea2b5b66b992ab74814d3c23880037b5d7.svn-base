...
public class QueryFmyNewWestSpandProduseServiceClientImpl extends BaseClientServiceImpl implements IQueryFmyNewWestSpandProduseService
{
	public QRY010029Result queryNewWestFmySpandProduse(String subSid, String cycle, Integer qryType, String qrysubsid) throws LIException
	{
		...
		try
		{
			...
			if(__ret instanceof QRY010029Result)
			{
				__result = (QRY010029Result)__ret;
			}
			else
			{
				__result = new QRY010029Result();
