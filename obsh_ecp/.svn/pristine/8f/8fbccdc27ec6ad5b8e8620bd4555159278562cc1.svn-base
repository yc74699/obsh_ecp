...
public class B2bqryDisOrderCountDetailServiceClientImpl extends
		BaseClientServiceImpl implements IB2bqryDisOrderCountDetailService {

	public B2B008Result b2bqryDisOrderCountDetail(String region, String operId,
			String disorderId) throws LIException {
		...
		try
		{
			...
			if(__ret instanceof B2B008Result)
			{
				__result = (B2B008Result)__ret;
			}
			else
			{
				__result = new B2B008Result();
