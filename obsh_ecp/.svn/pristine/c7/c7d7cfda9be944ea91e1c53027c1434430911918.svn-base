...
import com.xwtech.xwecp.service.logic.client_impl.common.impl.TransactRelationNumServiceClientImpl;
import com.xwtech.xwecp.service.logic.pojo.DEL040003Result;

public class DEL040003Test
{
	private static final Logger logger = Logger.getLogger(DEL040003Test.class);
...
//		props.put("platform.url", "http://10.32.65.238:8081/sms_ecp/xwecp.do");
		...
		ITransactRelationNumService co = new TransactRelationNumServiceClientImpl();
		//动感地带 13401312424  brand_id：11 city_id：17 user_id：1738200005062065
		//全球通 13913032424 user_id：1419200008195160
		//1、开通 2、关闭 3、变更
		//1、立即 2、次日 3、次月
		DEL040003Result re = co.transactRelationNum("13913032424", "13813382424", 1, 1, "QQHMZHKT_ZDXF30Y");
		logger.info(" ====== 开始返回参数 ======");
		if (re != null)
		{
