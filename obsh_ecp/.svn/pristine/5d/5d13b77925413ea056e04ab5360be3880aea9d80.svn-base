...
public class QueryUserBalanceServiceClientImpl extends BaseClientServiceImpl implements IQueryUserBalanceService
{
	public QRY010003Result queryUserBalance(String phoneNum, int type) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY010003";
		...
		try
		{
			...
			if(__ret instanceof QRY010003Result)
			{
				__result = (QRY010003Result)__ret;
			}
			else
			{
				__result = new QRY010003Result();
