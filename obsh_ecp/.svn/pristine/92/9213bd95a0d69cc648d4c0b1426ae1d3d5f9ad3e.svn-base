...
import com.xwtech.xwecp.service.logic.client_impl.common.IQueryViceNumberService;
import com.xwtech.xwecp.service.logic.pojo.QRY050014Result;

public class QueryViceNumberServiceClientImpl extends BaseClientServiceImpl implements IQueryViceNumberService
{
	public QRY050014Result queryViceNumber(int queryType, String number) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY050014";
		...
		try
		{
			...
			if(__ret instanceof QRY050014Result)
			{
				__result = (QRY050014Result)__ret;
			}
			else
			{
				__result = new QRY050014Result();
