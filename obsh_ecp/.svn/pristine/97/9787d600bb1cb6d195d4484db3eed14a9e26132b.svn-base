...
public class PhonePayServiceClientImpl extends BaseClientServiceImpl implements IPhonePayService
{
	public DEL040054Result phonePay(String phoneNum, String amount, String bankcode, String payFlag) throws LIException
	{
		...
		RequestParameter __param_payFlag = new RequestParameter("flag", payFlag);
		...
		try
		{
			...
			if(__ret instanceof DEL040054Result)
			{
				__result = (DEL040054Result)__ret;
			}
			else
			{
				__result = new DEL040054Result();
