 ...
 * 
 */
public class AliPayWapInvocation extends BaseInvocation implements ILogicalService {
	private static final Logger logger = Logger.getLogger(AliPayWapInvocation.class);
...
//		
	...
	public BaseServiceInvocationResult executeService(String accessId, ServiceConfig config, List<RequestParameter> params) {
		DEL040029Result res = new DEL040029Result();
...
//	}
	 ...
	 * @throws Exception
	 */
	protected void setTranValue(DEL040029Result res, String userCity, String unionPaySrl, 
...
//			System.out.println("sHtmlText=======" + sHtmlText);
	...
	protected BaseResult generateOrder(final String accessId, final ServiceConfig config, final List<RequestParameter> params,
			final DEL040029Result result, final String bossTemplate) {
		BaseResult res = new BaseResult();
		String reqXml = "";
		String rspXml = "";
