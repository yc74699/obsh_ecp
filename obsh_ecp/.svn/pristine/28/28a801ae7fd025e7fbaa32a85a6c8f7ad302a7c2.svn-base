...
public class QueryPackageDependServiceClientImpl extends BaseClientServiceImpl implements IQueryPackageDependService
{
	public QRY050028Result queryPackageDepend(String phoneNum, String city, String proId, String oldPckCode, String newPckCode, String packageType) throws LIException
	{
		...
		try
		{
			...
			if(__ret instanceof QRY050028Result)
			{
				__result = (QRY050028Result)__ret;
			}
			else
			{
				__ret = new QRY050028Result();
