...
public class QRY040067Test
{
	private static final Logger logger = Logger.getLogger(QRY040067Test.class);
...
//		props.put("platform.url", "http://10.32.229.103:10004/obsh_ecp/xwecp.do");
		...
		IQueryBugGetStrService co = new QueryBugGetStrServiceClientImpl();
//		QRY040067Result re = co.queryBugGetStr("13921078544", "17","","","");
		QRY040067Result re = co.queryBugGetStr("13921078544", "17","","");
		logger.info(" ====== 开始返回参数 ======");
		if (re != null)
		{
			...
			logger.info(" === re.getBugGetStr() === " + re.getBugGetStr());
		}
	}
}
