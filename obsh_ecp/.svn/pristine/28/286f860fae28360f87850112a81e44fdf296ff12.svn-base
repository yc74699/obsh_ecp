...
public class QueryThreeYearsAgoScoreServiceClientImpl extends BaseClientServiceImpl implements IQueryThreeYearsAgoScoreService
{
	 public QRY030009Result queryThreeYearsAgoScore(String phoneNum, String qrytype) throws LIException
	{
		long __beginTime = System.currentTimeMillis(); 
		String __cmd = "QRY030009";
		...
		try
		{
			...
			if(__ret instanceof QRY030009Result)
			{
				__result = (QRY030009Result)__ret;
			}
			else
			{
				__result = new QRY030009Result();
