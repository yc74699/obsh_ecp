...
public class QuitOutXQWServiceClientImpl extends BaseClientServiceImpl implements IQuitOutXQWService
{
	public DEL010011Result quitOutXQWOperation(String grpsubsid, String servicestartefft, String phoneNum) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "DEL010011";
		...
		try
		{
			...
			if(__ret instanceof DEL010011Result)
			{
				__result = (DEL010011Result)__ret;
			}
			else
			{
				__result = new DEL010011Result();
