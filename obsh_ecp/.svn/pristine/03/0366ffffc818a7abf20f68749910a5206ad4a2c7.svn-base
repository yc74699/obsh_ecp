 ...
 * 2015-01-27
 */
public class QueryMarketplandischkServiceClientImpl extends BaseClientServiceImpl implements IQueryMarketplandischkService
{
	public QRY040097Result queryMarketplandischk(String servnumber,String actid,String privid) throws LIException
	{
