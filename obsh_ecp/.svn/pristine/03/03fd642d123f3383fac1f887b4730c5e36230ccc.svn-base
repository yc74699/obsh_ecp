...
import com.xwtech.xwecp.service.logic.client_impl.common.IDoSignCheckByIcAndRelBand;
import com.xwtech.xwecp.service.logic.pojo.DEL040063Result;

public class DoSignCheckByIcAndRelBandServiceClientImpl extends
		BaseClientServiceImpl implements IDoSignCheckByIcAndRelBand {

	public DEL040063Result doSignCheckByIcAndRelBand(
			String phoneNum, String certType, String certId, 
			String custName, String vtelNum, String recType) throws LIException {
		long __beginTime = System.currentTimeMillis();
		String __cmd = "DEL040063";
		...
		try
		{
			...
			if(__ret instanceof DEL040063Result)
			{
				__result = (DEL040063Result)__ret;
