...
public class InternetPwdResetServiceClientImpl extends BaseClientServiceImpl implements IInternetPwdResetService
{
	public DEL030004Result modifyAndResetMbandPwd(String phoneNum, String oldpwd, String newpwd, String subcmdid) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "DEL030004";
		...
		try
		{
			...
			if(__ret instanceof DEL030004Result)
			{
				__result = (DEL030004Result)__ret;
			}
			else
			{
				__result = new DEL030004Result();
