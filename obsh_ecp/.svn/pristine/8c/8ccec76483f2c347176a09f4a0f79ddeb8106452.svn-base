...
public class QryOrderInfoServiceClientImpl extends BaseClientServiceImpl implements IQryOrderInfoService {
	
	public QRY040090Result qryOrderInfo(int qryType, String phoneNum,
			String operId) throws LIException {
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040090";
		...
		try
		{
			...
			if(__ret instanceof QRY040090Result)
			{
				__result = (QRY040090Result)__ret;
			}
			else
			{
			__result = new QRY040090Result();
