...
public class QueryUserPayTypeClientImpl extends BaseClientServiceImpl implements IQueryUserPayType
{
	public QRY040039Result queryUserPayType(String msisdn) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040039";
		...
		try
		{
			...
			if(__ret instanceof QRY040039Result)
			{
				__result = (QRY040039Result)__ret;
			}
			else
			{
				__result = new QRY040039Result();
