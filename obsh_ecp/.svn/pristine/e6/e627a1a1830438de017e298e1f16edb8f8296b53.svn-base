...
import com.xwtech.xwecp.service.logic.client_impl.common.IHKuserIncremService;
import com.xwtech.xwecp.service.logic.pojo.QRY020013Result;

public class HKuserIncremServiceClientImpl extends BaseClientServiceImpl implements IHKuserIncremService
{
	public QRY020013Result hKuserIncrem(String phoneNum, String opType, String effectType, String busiId) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY020013";
		...
		try
		{
			...
			if(__ret instanceof QRY020013Result)
			{
				__result = (QRY020013Result)__ret;
			}
			else
			{
				__result = new QRY020013Result();
