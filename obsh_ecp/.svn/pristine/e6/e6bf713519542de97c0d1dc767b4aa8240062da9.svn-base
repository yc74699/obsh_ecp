...
import com.xwtech.xwecp.service.logic.client_impl.common.impl.GetTableServerInfoServiceClientImpl;
...
public class EXT010001Test {
	...
	public static void main(String[] args) throws Exception
	{
		...
		IGetTableServerInfoService is = new GetTableServerInfoServiceClientImpl();
		
		EXT010001Result re = is.getTableServerInfo("", "", "", "", "", "bigTable","wt_2","1");
		System.out.println(re.getResultJson());
		logger.info(" ====== 开始返回参数 ======");
//		if(null != re){
