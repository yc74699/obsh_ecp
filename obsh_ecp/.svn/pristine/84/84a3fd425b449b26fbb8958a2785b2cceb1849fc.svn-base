...
import com.xwtech.xwecp.service.logic.client_impl.common.IGetUsrTransMainProduct;
import com.xwtech.xwecp.service.logic.pojo.QRY050041Result;

public class GetUsrTransMainProductClientImpl extends BaseClientServiceImpl implements IGetUsrTransMainProduct
{
	public QRY050041Result getUsrTransMainProduct(String phoneNum, String userId, String fromCity, String toCity) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY050041";
		...
		try
		{
			...
			if(__ret instanceof QRY050041Result)
			{
				__result = (QRY050041Result)__ret;
			}
			else
			{
				__result = new QRY050041Result();
