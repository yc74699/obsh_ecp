...
public class TBankWithDrawAccountServiceClientImpl extends BaseClientServiceImpl implements ITBankWithDrawAccountService{
	...
	public DEL040084Result withDrawAccount(String phoneNum,String oprType,String bizNo, String amount) throws LIException {
		...
		try
		{
			...
			if(__ret instanceof DEL040084Result)
			{
				__result = (DEL040084Result)__ret;
			}
			else
			{
				__result = new DEL040084Result();
