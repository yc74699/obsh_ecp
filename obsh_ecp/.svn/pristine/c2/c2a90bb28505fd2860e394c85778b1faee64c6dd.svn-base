...
public class PayByCardServiceClientImpl extends BaseClientServiceImpl implements IPayByCardService
{
	public DEL040005Result payByCard(String fromNum, String toNum, String cardNo) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "DEL040005";
		...
		try
		{
			...
			if(__ret instanceof DEL040005Result)
			{
				__result = (DEL040005Result)__ret;
			}
			else
			{
				__result = new DEL040005Result();
