...
public class CheckCreditServiceClientImpl extends BaseClientServiceImpl implements ICheckCreditService {

	public QRY040102Result checkCredit(String msisdn , String city) throws LIException {
