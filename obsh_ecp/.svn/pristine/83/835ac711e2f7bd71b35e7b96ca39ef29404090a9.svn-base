...
import com.xwtech.xwecp.service.logic.client_impl.common.impl.DoBankMainQryAndRecServiceClientImpl;
...
import com.xwtech.xwecp.service.logic.pojo.PayBlackTelInfo;
import com.xwtech.xwecp.service.logic.pojo.QRY050070Result;

public class QRY050070Test {
...
//		props.put("platform.url", "http://10.32.65.223:8082/obsh_ecp/xwecp.do");
		...
		IDoBankMainQryAndRec idb = new DoBankMainQryAndRecServiceClientImpl();
		QRY050070Result res = new QRY050070Result();
		try {
			res = idb.doBankMainQryAndRec("0", "13625151208", "14", "A","13675152070");
		} catch (LIException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		System.out.println(res);
		List resList = res.getPayBlackTelInfo();
		for(int i = 0;i<resList.size(); i++)
		{
			PayBlackTelInfo pay = (PayBlackTelInfo)resList.get(i);
			System.out.println("getBlacktel =================== "+pay.getBlacktel());
		}
	}
}
