...
public class NXSPayServiceClientImpl extends BaseClientServiceImpl implements INXSPayService
{
	public DEL040100Result nXSPayService(String phoneNum, String amount, String cityNum, String bankcode, String payFlag) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "DEL040100";
		...
		try
		{
			...
			if(__ret instanceof DEL040100Result)
			{
				__result = (DEL040100Result)__ret;
			}
			else
			{
			__result = new DEL040100Result();
