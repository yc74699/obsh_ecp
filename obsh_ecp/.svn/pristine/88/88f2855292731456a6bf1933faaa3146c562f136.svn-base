...
public class CustomDataSubmitSelfServiceClientImpl extends BaseClientServiceImpl
				implements ICustomDataSubmitSelfService {

	public DEL040109Result customDataSubmitSelf(String phoneNum, String custName,
			String city, String country, String icNo, String icAddr,
			String postNo, String postAddr, String phoneCall, String siteId,
			String siteName, String siteAddr, String fetchType,
			String totalFee, String emsNo, String proId, String brandId,
			String payType, List<ProPackage> proPackages,
			List<ProService> proServices, List<ProIncrement> proIncrements,
			List<ProSelf> proSelfs, String marketId, String marketLevelId,
			String busiPackId, String busiGoodsId, String marketfee,
			String recId, String bookingId, String IMSI, String REGION)
			throws LIException {
		long __beginTime = System.currentTimeMillis();
		String __cmd = "DEL040109";
		...
		try
		{
			...
			if(__ret instanceof DEL040109Result)
			{
				__result = (DEL040109Result)__ret;
			}
			else
			{
				__result = new DEL040109Result();
