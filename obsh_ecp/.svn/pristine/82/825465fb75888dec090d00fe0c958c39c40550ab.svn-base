...
public class QryUsimCardCheckServiceClientImpl implements IQryUsimCardCheckService {

	public QRY040091Result qryUsimCardCheck(String cardsn, String password)
			throws LIException {
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040091";
		...
		try
		{
			...
			if(__ret instanceof QRY040091Result)
			{
				__result = (QRY040091Result)__ret;
			}
			else
			{
			__result = new QRY040091Result();
