...
public class QueryGroupUserUsedInfoServiceClientImpl extends BaseClientServiceImpl implements IQueryGroupUserUsedInfoService
{
	public QRY040051Result queryGroupUserUsedInfo(String phoneNum) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040051";
		...
		try
		{
			...
			if(__ret instanceof QRY040051Result)
			{
				__result = (QRY040051Result)__ret;
			}
			else
			{
				__result = new QRY040051Result();
