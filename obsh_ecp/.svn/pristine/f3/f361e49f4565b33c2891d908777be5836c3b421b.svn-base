...
public class FlowFreezeServiceClientImpl extends BaseClientServiceImpl implements IFlowFreezeService {

	public DEL610051Result flowFreeze(String formNum,
			String servNumber, String paySubType, String flowValue)
			throws LIException {
		long __beginTime = System.currentTimeMillis();
		String __cmd = "DEL610051";
		...
		try
		{
			...
			if(__ret instanceof DEL610051Result)
			{
				__result = (DEL610051Result)__ret;
			}
			else
			{
				__result = new DEL610051Result();
