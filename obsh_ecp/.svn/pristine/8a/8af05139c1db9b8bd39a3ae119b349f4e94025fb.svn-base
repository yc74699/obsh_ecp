 ...
 * 
 */
public class BankNetPayInvocation extends BaseInvocation implements ILogicalService {
	 ...
	 * BOSS接口-验证业务
	 */
	private static final String BOSS_INTERFACE_VALIDATE_ORDER = "cc_cccbdeal_231";
	 ...
	 * 交易码, 目前为520100
	 */
	private static final String TXCODE = "520100";
	 ...
	 */
	@SuppressWarnings("unchecked")
//	private boolean checkHomeMaster(String accessId, ServiceConfig config, List<RequestParameter> params, DEL040025Result res) {
//		boolean rs = false;
//		String reqXml = "";
//		String rspXml = "";
//		try {
