...
public class CheckVnetXQWMemberServiceClientImpl extends BaseClientServiceImpl implements ICheckVnetXQWMemberService
{
	public QRY040029Result checkVnetXQWMemberInfo(String phoneNum) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040029";
		...
		try
		{
			...
			if(__ret instanceof QRY040029Result)
			{
				__result = (QRY040029Result)__ret;
			}
			else
			{
				__result = new QRY040029Result();
