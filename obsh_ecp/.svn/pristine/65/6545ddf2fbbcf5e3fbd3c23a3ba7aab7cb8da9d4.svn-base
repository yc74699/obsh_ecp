...
public class DEL040020Test {
	private static final Logger logger = Logger.getLogger(DEL040020Test.class);
	...
	public static void main(String[] args) throws Exception
	{
		...
		ic.addContextParameter("user_id", "1210200002955972");
		
		lic.setContextParameter(ic);
		//
		
		IDealExtCardService co = new DealExtCardServiceClientImpl();
		DEL040020Result re = co.dealExtCard("13651542424","2012042615",1);
