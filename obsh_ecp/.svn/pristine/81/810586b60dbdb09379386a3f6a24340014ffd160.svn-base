...
public class UnionPayServiceClientImpl extends BaseClientServiceImpl implements IUnionPayService
{
	public DEL040010Result unionPay(String phoneNum, int payFlag, String amount) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "DEL040010";
		...
		try
		{
			...
			if(__ret instanceof DEL040010Result)
			{
				__result = (DEL040010Result)__ret;
			}
			else
			{
				__result = new DEL040010Result();
