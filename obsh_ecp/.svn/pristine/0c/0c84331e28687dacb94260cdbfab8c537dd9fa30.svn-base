...
public class QueryMobileGameServiceClientImpl extends BaseClientServiceImpl implements IQueryMobileGameService
{
	public QRY020010Result queryMobileGame(String phoneNum) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY020010";
		...
		try
		{
			...
			if(__ret instanceof QRY020010Result)
			{
				__result = (QRY020010Result)__ret;
			}
			else
			{
				__result = new QRY020010Result();
