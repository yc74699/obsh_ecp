...
public class QRY040065Test {
	private static final Logger logger = Logger.getLogger(QRY040065Test.class);
	...
	public static void main(String[] args) throws Exception
	{
		...
		IQrygprsSectionfluxService co = new QrygprsSectionfluxServiceClientImpl();
		QRY040065Result re = co.qryGprsSectionFlux("201401");
		System.out.println(" ====== 开始返回参数 ======");
		if (re != null)
		{
			System.out.println(" ====== getResultCode ======" + re.getResultCode());
			System.out.println(" ====== getResultCode ======" + re.getErrorMessage());
			System.out.println(" ====== getTwoNetFlux ======" + re.getTwoNetFlux());
			System.out.println(" ====== getThreeNetFlux ======" + re.getThreeNetFlux());
			System.out.println(" ====== getFourNetFlux ======" + re.getFourNetFlux());
		}
	}
}
