...
import com.xwtech.xwecp.service.logic.client_impl.common.IQueryNewSpandProduseCHService;
import com.xwtech.xwecp.service.logic.pojo.QRY040109Result;

public class QueryNewSpandProduseCHServiceClientImpl extends BaseClientServiceImpl implements IQueryNewSpandProduseCHService
{
	public QRY040109Result queryNewSpandProduseCH(String subSid, String cycle, Integer qryType, String qrysubsid, String isPool) throws LIException
	{
