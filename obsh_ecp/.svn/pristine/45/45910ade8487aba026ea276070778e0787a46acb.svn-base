...
public class QueryFreeTimesServiceClientImpl extends BaseClientServiceImpl implements IQueryFreeTimesService {

	public QRY050067Result getLeftFreeTimes(String phoneNum, String city)
			throws Exception {
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY050067";
		...
		try
		{
			...
			if(__ret instanceof QRY050067Result)
			{
				__result = (QRY050067Result)__ret;
			}
			else
			{
				__result = new QRY050067Result();
