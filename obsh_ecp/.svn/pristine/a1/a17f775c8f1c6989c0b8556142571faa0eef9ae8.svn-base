 ...
 * 2014-05-08
 */
public class QueryGrpCustOrderChannelServiceClientImpl extends BaseClientServiceImpl implements IQueryGrpCustOrderChannelService
{
	public QRY010035Result qryGrpCustOrderChannel(String custid,String qryChannel) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY010035";
		...
		RequestParameter __param_qryChannel = new RequestParameter("qryChannel", qryChannel);
		__requestData.getParams().add(__param_qryChannel);
		...
		try
		{
			...
			if(__ret instanceof QRY010035Result)
			{
				__result = (QRY010035Result)__ret;
			}
			else
			{
				__ret = new QRY010035Result();
