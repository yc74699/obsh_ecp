...
public class QueryScoreReserveDetailServiceClientImpl extends BaseClientServiceImpl implements IQueryScoreReserveDetailService
{
	public QRY030004Result queryScoreReserveDetail(String phoneNum, String beginDate, String endDate) throws LIException
	{
		...
		try
		{
			...
			if(__ret instanceof QRY030004Result)
			{
				__result = (QRY030004Result)__ret;
			}
			else
			{
				__result = new QRY030004Result();
