 ...
 */
public class QueryNewMobileStateInvocation extends BaseInvocation implements ILogicalService {
	private static final Logger logger = Logger.getLogger(QueryNewMobileStateInvocation.class);
	private IZxrwDAO zxrwDAO;
	public QueryNewMobileStateInvocation() {
	...
	public BaseServiceInvocationResult executeService(String accessId, ServiceConfig config, List<RequestParameter> params) {
		...
		try {
			...
			String state = zxrwDAO.queryMobileState(mobile, orderId);
