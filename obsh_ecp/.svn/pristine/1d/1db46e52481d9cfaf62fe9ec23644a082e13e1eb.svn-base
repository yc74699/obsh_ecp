...
public class VirtualFamilyProdInstallClientService extends BaseClientServiceImpl implements IVirtualFamilyProdInstallService
{

	/**
	 * 家庭V网短号套餐订购,请求报文
	 */
	public DEL610047Result virtualFamilyProdInstall(String familysubsid,String pkgprodid, String increprodid, String effecttype,
			List<MemberinfoIn> memberInfoIn) throws LIException
	{
		
		long __beginTime = System.currentTimeMillis();
		String __cmd = "DEL610047";
		...
		try
		{
			...
			if(__ret instanceof DEL610047Result)
			{
				__result = (DEL610047Result)__ret;
			}
			else
			{
				__result = new DEL610047Result();
