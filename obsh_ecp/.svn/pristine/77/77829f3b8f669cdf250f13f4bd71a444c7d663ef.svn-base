...
public class GetUsrTransTemByProIdClientImpl extends BaseClientServiceImpl implements IGetUsrTransTemByProId
{
	public QRY050044Result getUsrTransTemByProId(String userId, String proId, String fromCity) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY050044";
		...
		try
		{
			...
			if(__ret instanceof QRY050044Result)
			{
				__result = (QRY050044Result)__ret;
			}
			else
			{
				__result = new QRY050044Result();
