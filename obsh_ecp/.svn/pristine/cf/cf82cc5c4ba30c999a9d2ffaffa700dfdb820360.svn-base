...
public  class QryUserActByImeiServiceClientImpl extends BaseClientServiceImpl implements IQryUserActByImeiService
{
	public QRY090101Result qryUserActByImei(String imeiid) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY090101";
		...
		try
		{
			...
			if(__ret instanceof QRY090101Result)
			{
				__result = (QRY090101Result)__ret;
			}
			else
			{
				__result = new QRY090101Result();
