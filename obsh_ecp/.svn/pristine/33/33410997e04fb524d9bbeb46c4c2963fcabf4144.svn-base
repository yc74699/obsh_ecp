...
public class QueryRecLogServiceClientImpl extends BaseClientServiceImpl implements IQueryRecLogService
{
	public QRY050057Result queryRecLog(String msisdn, long qryhis) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY050057";
		...
		try
		{
			...
			if(__ret instanceof QRY050057Result)
			{
				__result = (QRY050057Result)__ret;
			}
			else
			{
				__result = new QRY050057Result();
