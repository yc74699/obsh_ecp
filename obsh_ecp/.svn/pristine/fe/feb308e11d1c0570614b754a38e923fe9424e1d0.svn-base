...
public class QueryStudentOrderInfoServiceClientImpl extends BaseClientServiceImpl implements IQueryStudentOrderInfoService {

	public QRY610043Result queryStudentOrderInfo(String qryType, String qryValue)
			throws LIException {
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY610043";
		...
		try
		{
			...
			if(__ret instanceof QRY610043Result)
			{
				__result = (QRY610043Result)__ret;
			}
			else
			{
			__result = new QRY610043Result();
