...
public class MultiNumBlackListDelServiceClientImpl extends
		BaseClientServiceImpl implements IMultiNumBlackListDelService {

	public DEL040062Result multiNumBlackListDel(String userCity,
			String userSid,String vnumSid,String isdelall, List<BlackListInfo> blackListInfo)
			throws LIException {
		long __beginTime = System.currentTimeMillis();
		String __cmd = "DEL040062";
		...
		RequestParameter __param_isdelall = new RequestParameter("isdelall", isdelall);
		__requestData.getParams().add(__param_isdelall);
		...
		try
		{
			...
			if(__ret instanceof DEL040062Result)
			{
				__result = (DEL040062Result)__ret;
			}
			else
			{
				__ret = new DEL040062Result();
