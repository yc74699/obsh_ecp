...
import com.xwtech.xwecp.service.logic.client_impl.common.IPaymentBalanceService;
import com.xwtech.xwecp.service.logic.pojo.QRY610047Result;

public class PaymentBalanceServiceClientImpl extends BaseClientServiceImpl implements IPaymentBalanceService{

	public QRY610047Result paymentBalance(String ddr_city, String servnumber,
			String formnum, String paytype, String accesstype, String levelid,
			String payfee, String paysubtype, String payflowvalue,
			String startdate, String enddate, String taskoid)
			throws LIException {
		
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY610047";
		...
		try
		{
			...
			if(__ret instanceof QRY610047Result)
			{
				__result = (QRY610047Result)__ret;
			}
			else
			{
				__result = new QRY610047Result();
