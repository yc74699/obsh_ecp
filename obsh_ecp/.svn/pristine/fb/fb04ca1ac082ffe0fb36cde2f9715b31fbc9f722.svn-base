...
import com.xwtech.xwecp.service.logic.client_impl.common.impl.BindInterFeePayServiceClientImpl;
...
private static final Logger logger = Logger.getLogger(QRY040014TestApp.class);
	...
	public static void main(String[] args) throws Exception
	{
		...
		IBindInterFeePayService service = new BindInterFeePayServiceClientImpl();
		
		
		//payedPhoneNum      上网账号
		//payedPhoneNumPwd   上网密码
		//interType          上网类型  (1:宽带上网 2:随E行上网)
		//dealType            变更类型 (1:绑定 2:取消绑定)
		DEL040019Result res = service.bindInterFeePay("phoneNum", "password", "payedPhoneNum", "payedPhoneNumPwd", "interType", "dealType");
