...
public class DelBlackBerryServiceClientImpl extends BaseClientServiceImpl implements IDelBlackBerryService
{
	public DEL010009Result delBlackBerry(String phoneNum, String id, int oprType, int chooseFlag) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "DEL010009";
		...
		try
		{
			...
			if(__ret instanceof DEL010009Result)
			{
				__result = (DEL010009Result)__ret;
			}
			else
			{
				__result = new DEL010009Result();
