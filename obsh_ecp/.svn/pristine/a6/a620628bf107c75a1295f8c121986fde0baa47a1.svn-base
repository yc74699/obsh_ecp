...
public class CancelIncrementServiceClientImpl extends BaseClientServiceImpl implements ICancelIncrementService
{
	public DEL010006Result cancelIncrement(String phoneNum, String orderId) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "DEL010006";
		...
		try
		{
			...
			if(__ret instanceof DEL010006Result)
			{
				__result = (DEL010006Result)__ret;
			}
			else
			{
				__result = new DEL010006Result();
