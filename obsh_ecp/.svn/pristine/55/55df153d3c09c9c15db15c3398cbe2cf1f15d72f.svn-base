...
public class TransactBroadServiceClientImpl extends BaseClientServiceImpl implements ITransactBroadService
{
	public DEL060004Result transactBroad(String bossmms_services_type, String ddr_city, String usermarketingbaseinfo_user_id, int id_type, String detail_operating_srl, String marketingbusiinfo_busi_pack_id, String bossmms_pack_id, String creditreleasegrade_grade_amount, String usermarketingbaseinfo_plan_id,String rewardlist) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "DEL060004";
...
//		{
//			__param_marketingbusiinfo_busi_pack_id=new RequestParameter("marketingbusiinfo_busi_pack_id", "");;
//		}
...
//		if(null != rewardlist && !"".equals(rewardlist))
//		{
//			__param_bossmms_pack_id=new RequestParameter("bossmms_pack_id", "");;
//		}
		...
		try
		{
			...
			if(__ret instanceof DEL060004Result)
			{
				__result = (DEL060004Result)__ret;
			}
			else
			{
				__result = new DEL060004Result();
