...
public class QueryGPSFluxInfoInvocation extends BaseInvocation implements
	...
	private static final Logger logger = Logger.getLogger(QueryGPSFluxInfoInvocation.class);
...
//		List<String> anomalylist  = this.getAnomalyGprs();
	 ...
	 * @return
	 */
	/*private String getUsercust(String accessId, ServiceConfig config, List<RequestParameter> params,QRY040048Result res)
	{   
