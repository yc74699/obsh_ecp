...
public class OrderCreditServiceClientImpl extends BaseClientServiceImpl implements IOrderCreditService {

	public DEL040114Result orderCredit(String msisdn, String city)
			throws LIException {
		long __beginTime = System.currentTimeMillis();
		String __cmd = "DEL040114";
		...
		try
		{
			...
			if(__ret instanceof DEL040114Result)
			{
				__result = (DEL040114Result)__ret;
			}
			else
			{
				__result = new DEL040114Result();
