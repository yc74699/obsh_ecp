...
public class QryExperCfgServiceClientImpl extends BaseClientServiceImpl implements IQryExperCfgService
{
	public QRY050005Result qryExperCfg(String phoneNum, String ddrCity, int qryFlag) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY050005";
		...
		try
		{
			...
			if(__ret instanceof QRY050005Result)
			{
				__result = (QRY050005Result)__ret;
			}
			else
			{
				__result = new QRY050005Result();
