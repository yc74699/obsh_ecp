...
public class GetEdtByCtrServiceClientImpl extends BaseClientServiceImpl implements IGetEdtByCtrService
{
	public QRY050065Result getEdtByCtr(String ddr_city, String contractid, String agreeoid) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY050065";
		...
		RequestParameter __param_agreeoid = new RequestParameter("agreeoid", agreeoid);
		__requestData.getParams().add(__param_agreeoid);
		...
		try
		{
			...
			if(__ret instanceof QRY050065Result)
			{
				__result = (QRY050065Result)__ret;
			}
			else
			{
				__result = new QRY050065Result();
