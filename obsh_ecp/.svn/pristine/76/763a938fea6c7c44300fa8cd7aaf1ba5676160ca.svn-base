...
public class MarketChgprodPerckServiceClientImpl extends BaseClientServiceImpl implements IMarketChgprodPerckService {

	public QRY040098Result qryMarketChgProdCk(String city, String phoneNum,
			String prodID, String operType) throws LIException {
