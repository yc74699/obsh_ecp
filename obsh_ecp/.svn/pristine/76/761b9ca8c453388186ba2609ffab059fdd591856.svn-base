...
public class QueryUsrTransNoEffectiveUsrInfoClientImpl extends BaseClientServiceImpl implements IQueryUsrTransNoEffectiveUsrInfo
{
	public QRY050043Result getUsrTransNoEffectiveUsrInfo(String phoneNum) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY050043";
		...
		try
		{
			...
			if(__ret instanceof QRY050043Result)
			{
				__result = (QRY050043Result)__ret;
			}
			else
			{
				__result = new QRY050043Result();
