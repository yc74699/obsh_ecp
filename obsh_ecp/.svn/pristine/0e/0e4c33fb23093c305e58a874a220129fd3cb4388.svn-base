...
import com.xwtech.xwecp.service.logic.client_impl.common.IQryFamilyPayPlan;
import com.xwtech.xwecp.service.logic.client_impl.common.impl.QryFamilyPayPlanClientImpl;
import com.xwtech.xwecp.service.logic.pojo.QRY050059Result;


public class QRY050059Test
{
	private static final Logger logger = Logger.getLogger(QRY050059Test.class);
	...
	public static void main(String[] args) throws Exception
	{
		...
		if (re != null)
		{
			...
			logger.info(" ====== 111 ======" + re.getFamilytype());
