...
public class QueryGoodsDetailByPkgIdServiceClientImpl extends BaseClientServiceImpl implements IQueryGoodsDetailByPkgIdService
{
	public QRY070007Result queryGoodsDetailByPkgId(String actId, String packid) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY070007";
		...
		try
		{
			...
			if(__ret instanceof QRY070007Result)
			{
				__result = (QRY070007Result)__ret;
			}
			else
			{
				__result = new QRY070007Result();
