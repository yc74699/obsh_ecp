...
public class DoMobilePayOperServiceClientImpl extends BaseClientServiceImpl implements IdoMobilePayOperService
{
	public DEL040052Result domobilePayOper(String mobile, String oprtype, String trigamt, String drawamt, String ispost) throws LIException
	{
		...
		RequestParameter __param_ispost = new RequestParameter("ispost", ispost);
		__requestData.getParams().add(__param_ispost);
		...
		try
		{
			...
			if(__ret instanceof DEL040052Result)
			{
				__result = (DEL040052Result)__ret;
			}
			else
			{
				__result = new DEL040052Result();
