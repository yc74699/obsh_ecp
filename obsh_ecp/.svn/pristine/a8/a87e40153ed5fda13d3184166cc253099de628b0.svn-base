...
import com.xwtech.xwecp.service.logic.client_impl.common.ILoginCHService;
import com.xwtech.xwecp.service.logic.client_impl.common.impl.LoginCHServiceClientImpl;
...
{
	private static final Logger logger = Logger.getLogger(QRY040111Test.class);
	...
	public static void main(String[] args) throws Exception
	{
		...
		ILoginCHService loginService = new LoginCHServiceClientImpl();
		QRY040111Result result = loginService.loginCH("13852280375",DESEncrypt.desString("778691", BOSS_SECRET_KEY));
		if (result != null)
		{
