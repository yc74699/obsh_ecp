...
public class QueryYxfaCheckServiceClientImpl extends BaseClientServiceImpl implements IQueryYxfaCheckService
{
	public QRY070005Result queryYxfaCheck(String ddr_city, String usermarketingbaseinfo_user_id, List<YxfaIdInfo> yxfaIdInfo) throws LIException
	{
		...
		try
		{
			...
			if(__ret instanceof QRY070005Result)
			{
				__result = (QRY070005Result)__ret;
			}
			else
			{
				__result = new QRY070005Result();
