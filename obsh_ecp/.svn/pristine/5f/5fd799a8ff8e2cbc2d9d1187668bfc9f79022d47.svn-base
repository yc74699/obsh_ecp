...
public class QueryMonthServiceClientImpl extends BaseClientServiceImpl implements IQueryMonthService
{
	public QRY030012Result qryMonthScore(String phoneNum, String startCycle, String endCycle, String qryType) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY030012";
		...
		try
		{
			...
			if(__ret instanceof QRY030012Result)
			{
				__result = (QRY030012Result)__ret;
			}
			else
			{
				__result = new QRY030012Result();
