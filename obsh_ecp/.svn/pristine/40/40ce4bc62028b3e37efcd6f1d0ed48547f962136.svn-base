 ...
 * 2014-10-23
 */
public class QueryOrderStatusServiceClientImpl extends BaseClientServiceImpl implements IQueryOrderStatusService
{
	public QRY040088Result queryOrderStatus(String ddr_city,String order_id) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040088";
		...
		try
		{
			...
			if(__ret instanceof QRY040088Result)
			{
				__result = (QRY040088Result)__ret;
			}
			else
			{
				__result = new QRY040088Result();
