...
public class TransMarketPlanBroadBandServiceClientImpl extends BaseClientServiceImpl implements ITransMarketPlanBroadBandService
{
	...
	{  
		...
		try
		{
			...
			if(__ret instanceof DEL100008Result)
			{
				__result = (DEL100008Result)__ret;
			}
			else
			{
				__result = new DEL100008Result();
