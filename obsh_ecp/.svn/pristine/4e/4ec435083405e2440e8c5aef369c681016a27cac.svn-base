 ...
 */
public class QueryPackageUsageInvocation extends BaseInvocation implements ILogicalService {
...
//	private Set<String> wlan;
	...
	public QueryPackageUsageInvocation()
	{
...
//		Set<String> set = new HashSet<String>();
	...
	private Map<String,String> getHouserHolder(List<RequestParameter> params,String accessId,QRY040020Result res) {
		String reqXml = "";
		String rspXml = "";
		String  houseId = "";
		RequestParameter parameter = getParameter(params, "context_user_id");
...
//						pkgInfo = new PkgInfo();
	 ...
	 * @return
	 */
	private List<Node> queryHousePackage(String accessId, ServiceConfig config, List<RequestParameter> params,QRY040020Result res,String userId,String phoneNum)
	{
		String reqXml = "";
		String rspXml = "";
	 ...
	 * @return
	 */
	/*private String getUsercust(String accessId, ServiceConfig config, List<RequestParameter> params,QRY040020Result res)
	{   

		try{
			String reqXml = this.bossTeletextUtil.mergeTeletext("cc_cgetusercust_69", params);
			logger.debug(" ====== 查询用户资料 ======\n" + reqXml);
			if (null != reqXml && !"".equals(reqXml))
			{
				String rspXml = (String)this.remote.callRemote(
				...
				{
					Document doc = DocumentHelper.parseText(rspXml);
					List<Node> freeItemNodes = doc.selectNodes("/operation_out/content");
					if(null != freeItemNodes && freeItemNodes.size()>0)
					{
						for(Node custDtNode : freeItemNodes){
							String isorder4gprod = custDtNode.selectSingleNode("./isorder4gprod").getText().trim();
							return isorder4gprod;
						}
					}
				}
			}
