...
public class GetQryFreeByIdServiceClientImpl extends BaseClientServiceImpl implements IGetQryFreeByIdService
{
	public QRY050064Result getQryFreeById(String ddr_city, String contractid) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY050064";
		...
		try
		{
			...
			if(__ret instanceof QRY050064Result)
			{
				__result = (QRY050064Result)__ret;
			}
			else
			{
				__result = new QRY050064Result();
