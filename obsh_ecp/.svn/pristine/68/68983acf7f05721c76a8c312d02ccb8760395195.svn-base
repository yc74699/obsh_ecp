...
public class QueryPhoneNumBySimServiceClientImpl extends BaseClientServiceImpl implements IQueryPhoneNumBySimService
{
	public QRY040009Result queryPhoneNumBySim(String sId, String password, String cityNum) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040009";
		...
		try
		{
			...
			if(__ret instanceof QRY040009Result)
			{
				__result = (QRY040009Result)__ret;
			}
			else
			{
				__ret = new QRY040009Result();
