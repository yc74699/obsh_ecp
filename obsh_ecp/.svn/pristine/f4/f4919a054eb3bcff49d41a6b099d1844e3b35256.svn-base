...
public class EMoneyPreVoucherServiceClientImpl extends BaseClientServiceImpl implements IeMoneyPreVoucherService
{
	public DEL040039Result eMoneyPreVoucher(String phoneNum, String amount, String payType, String recOid, String taskOid) throws LIException
	{
		...
		RequestParameter __param_recOid = new RequestParameter("recOid", recOid);
		__requestData.getParams().add(__param_recOid);
		...
		try
		{
			...
			if(__ret instanceof DEL040039Result)
			{
				__result = (DEL040039Result)__ret;
			}
			else
			{
				__result = new DEL040039Result();
