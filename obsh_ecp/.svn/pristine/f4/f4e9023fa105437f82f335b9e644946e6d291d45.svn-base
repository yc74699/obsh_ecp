...
public class QueryUserIncrementsServiceClientImpl extends BaseClientServiceImpl implements IQueryUserIncrementsService
{
	public QRY040023Result queryUserIncrements(String phoneNum, String type) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040023";
		...
		try
		{
			...
			if(__ret instanceof QRY040023Result)
			{
				__result = (QRY040023Result)__ret;
			}
			else
			{
				__result = new QRY040023Result();
