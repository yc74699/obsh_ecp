 ...
 *
 */
public class UnionPayMallServiceClientImpl extends BaseClientServiceImpl implements IUnionPayMallService {

	public DEL040111Result unionPayMall(String phoneNum, int payFlag, String amount)
			throws LIException {
		long __beginTime = System.currentTimeMillis();
		String __cmd = "DEL040111";
		...
		try
		{
			...
			if(__ret instanceof DEL040111Result)
			{
				__result = (DEL040111Result)__ret;
			}
			else
			{
				__result = new DEL040111Result();
