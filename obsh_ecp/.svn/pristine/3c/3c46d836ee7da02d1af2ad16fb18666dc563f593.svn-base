...
public class QueryMExchangeDetailServiceClientImpl extends BaseClientServiceImpl implements IQueryMExchangeDetailService
{
	public QRY030005Result queryMExchangeDetail(String phoneNum, String beginDate, String endDate) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY030005";
		...
		try
		{
			...
			if(__ret instanceof QRY030005Result)
			{
				__result = (QRY030005Result)__ret;
			}
			else
			{
				__result = new QRY030005Result();
