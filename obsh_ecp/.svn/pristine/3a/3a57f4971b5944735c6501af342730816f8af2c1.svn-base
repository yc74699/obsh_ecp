...
public class FlowUnFreezeServiceClientImpl extends BaseClientServiceImpl implements IFlowUnFreezeService{

	public DEL610052Result flowUnfreeze(String servNumber,
			String formNum, String frozeSrl, String flowValue)
			throws LIException {
		long __beginTime = System.currentTimeMillis();
		String __cmd = "DEL610052";
		...
		try
		{
			...
			if(__ret instanceof DEL610052Result)
			{
				__result = (DEL610052Result)__ret;
			}
			else
			{
				__result = new DEL610052Result();
