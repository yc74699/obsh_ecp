...
public class QueryEmailBizStateServiceClientImpl extends BaseClientServiceImpl implements IQueryEmailBizStateService
{
	public QRY020004Result queryEmailBizState(String phoneNum) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY020004";
		...
		try
		{
			...
			if(__ret instanceof QRY020004Result)
			{
				__result = (QRY020004Result)__ret;
			}
			else
			{
				__result = new QRY020004Result();
