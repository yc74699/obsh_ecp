...
import com.xwtech.xwecp.service.logic.client_impl.common.IGetCloseServiceService;
import com.xwtech.xwecp.service.logic.pojo.QRY050023Result;

public class GetCloseServiceServiceClientImpl extends BaseClientServiceImpl implements IGetCloseServiceService
{
	public QRY050023Result getCloseService(String phoneNum, String oldProId, String newProId) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY050023";
		...
		try
		{
			...
			if(__ret instanceof QRY050023Result)
			{
				__result = (QRY050023Result)__ret;
			}
			else
			{
				__result = new QRY050023Result();
