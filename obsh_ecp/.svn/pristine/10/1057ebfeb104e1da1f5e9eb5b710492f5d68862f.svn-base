...
import com.xwtech.xwecp.service.logic.client_impl.common.impl.ResidualFlowRelationServiceClientImpl;
 ...
 * 2014-7-28
 */
public class DEL040081Test
{
	private static final Logger logger = Logger.getLogger(DEL040081Test.class);
...
//		props.put("platform.url", "http://10.32.65.238:8080/wap_ecp/xwecp.do");
		...
		IResidualFlowRelationService query = new ResidualFlowRelationServiceClientImpl();
		DEL040081Result result = query.residualFlowRelation("","","","");
		if (result != null)
		{
