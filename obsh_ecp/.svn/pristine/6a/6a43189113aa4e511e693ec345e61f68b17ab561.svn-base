...
public class SuspendResumeServServiceClientImpl extends BaseClientServiceImpl implements ISuspendResumeServService
{
	public DEL030001Result suspendResumeServ(String phoneNum, int oprType) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "DEL030001";
		...
		try
		{
			...
			if(__ret instanceof DEL030001Result)
			{
				__result = (DEL030001Result)__ret;
			}
			else
			{
				__result = new DEL030001Result();
