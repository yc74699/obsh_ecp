...
public class MultiNumOperateServiceClientImpl extends BaseClientServiceImpl
		implements IMultiNumOperateService {

	public DEL040055Result multiNumOperate(String userCity, String subSid,
			MultiNumOperateInfo multinuminfo) throws LIException {
		long __beginTime = System.currentTimeMillis();
		String __cmd = "DEL040055";
		...
		RequestParameter __param_multinuminfo = new RequestParameter("multinuminfo", multinuminfo);
		__requestData.getParams().add(__param_multinuminfo);
		...
		try
		{
			...
			if(__ret instanceof DEL040055Result)
			{
				__result = (DEL040055Result)__ret;
			}
			else
			{
