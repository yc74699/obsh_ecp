...
public class GetUserProResourceServiceClientImpl extends BaseClientServiceImpl implements IGetUserProResourceService
{
	public QRY050022Result getUserProResource(String productId) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY050022";
		...
		try
		{
			...
			if(__ret instanceof QRY050022Result)
			{
				__result = (QRY050022Result)__ret;
			}
			else
			{
				__result = new QRY050022Result();
