...
public class QryUsermBandproddetailreqServiceClientImpl extends BaseClientServiceImpl implements IQryUsermBandproddetailreqService
{
	public QRY010044Result qryUsermBandproddetailreq(String telnum, String region) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY010044";
		...
		try
		{
			...
			if(__ret instanceof QRY010044Result)
			{
				__result = (QRY010044Result)__ret;
			}
			else
			{
			__result = new QRY010044Result();
