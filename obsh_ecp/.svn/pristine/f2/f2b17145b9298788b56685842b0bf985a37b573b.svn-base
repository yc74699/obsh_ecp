...
public class QueryUserTribeServiceClientImpl extends BaseClientServiceImpl implements IQueryUserTribeService
{
	public QRY050011Result queryUserTribe(String phoneNum) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY050011";
		...
		try
		{
			...
			if(__ret instanceof QRY050011Result)
			{
				__result = (QRY050011Result)__ret;
			}
			else
			{
				__result = new QRY050011Result();
