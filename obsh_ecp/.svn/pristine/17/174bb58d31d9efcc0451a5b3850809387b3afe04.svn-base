...
public class DEL010010Test
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		IAddToXQWService service = new AddToXQWServiceClientImpl();
		
		DEL010010Result result = service.addToXQWOperation("1211200007792998", "m1", "13770472424", "");
		
		System.err.println(result.getCustomerName());
		System.err.println(result.getAddDate());
