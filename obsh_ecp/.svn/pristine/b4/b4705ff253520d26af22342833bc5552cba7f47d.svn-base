...
public class ABCPayServiceClientImpl extends BaseClientServiceImpl implements IABCPayService
{
	public DEL040036Result bankABCPay(String phoneNum, String payFlag, String amount) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "DEL040036";
		...
		try
		{
			...
			if(__ret instanceof DEL040036Result)
			{
				__result = (DEL040036Result)__ret;
			}
			else
			{
				__result = new DEL040036Result();
