...
import com.xwtech.xwecp.service.logic.client_impl.common.impl.RecbindBankctsServiceClientImpl;
import com.xwtech.xwecp.service.logic.pojo.DEL040074Result;

public class DEL040074Test
{
	private static final Logger logger = Logger.getLogger(DEL040074Test.class);
...
//		props.put("platform.url", "http://10.32.229.103:10004/obsh_ecp/xwecp.do");
		...
		IRecbindBankctsService co = new RecbindBankctsServiceClientImpl();
		DEL040074Result re = co.recbindBankcts("15195370759", "0004","CMCC_UPAY","","","","");
		logger.info(" ====== 开始返回参数 ======");
		if (re != null)
		{
