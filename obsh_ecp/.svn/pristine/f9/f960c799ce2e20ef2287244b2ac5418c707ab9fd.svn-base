...
public class QueryAgentBalanceServiceClientImpl extends BaseClientServiceImpl implements IQueryAgentBalanceService
{
	public QRY040015Result queryAgentBalance(String phoneNum, String userId, String cityId) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040015";
		...
		try
		{
			...
			if(__ret instanceof QRY040015Result)
			{
				__result = (QRY040015Result)__ret;
			}
			else
			{
				__result = new QRY040015Result();
