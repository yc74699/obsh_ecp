...
public class QueryPkgUsedInfoCHServiceClientImpl extends BaseClientServiceImpl implements IQueryPkgUsedInfoCHService {

	public QRY040110Result queryPkgUsedInfoCH(String phoneNum, String isPool)
			throws LIException {
