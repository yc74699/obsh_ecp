...
public class CheckQryConductInvocation extends BaseInvocation implements
		ILogicalService {

	private static final Logger logger = Logger
			.getLogger(StopCmnetAndCmwapInvocation.class);
	...
	/*end*/
	public CheckQryConductInvocation() {
	...
	public BaseServiceInvocationResult executeService(String accessId,
		...
		QRY020018Result res = new QRY020018Result();
		if(isCheck(accessId,config,params, res))
		{
			res.setState("0");
			return res;
		} else {
	...
	private boolean isCheck(String accessId, ServiceConfig config,List<RequestParameter> params,QRY020018Result result)
	{
		try
		{
