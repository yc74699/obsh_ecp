...
public class QuerydetailByReceptionServiceClientImpl extends BaseClientServiceImpl implements IQuerydetailByReceptionService
{
	public QRY040033Result queryOperLogDetail(String phoneNum, String FORMNUM, String ddr_city) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040033";
		...
		try
		{
			...
			if(__ret instanceof QRY040033Result)
			{
				__result = (QRY040033Result)__ret;
			}
			else
			{
				__result = new QRY040033Result();
