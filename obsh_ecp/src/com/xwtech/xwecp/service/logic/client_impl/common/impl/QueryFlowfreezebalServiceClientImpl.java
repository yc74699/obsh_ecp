 ...
 * 2015-04-22
 */
public class QueryFlowfreezebalServiceClientImpl extends BaseClientServiceImpl implements IQueryFlowfreezebalService
{
	public  QRY610048Result flowfreezebal( 
			String 	formnum,
			String 	frozesrl) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY610048";
		...
		try
		{
			...
			if(__ret instanceof QRY610048Result)
			{
				__result = (QRY610048Result)__ret;
			}
			else
			{
				__result = new QRY610048Result();
