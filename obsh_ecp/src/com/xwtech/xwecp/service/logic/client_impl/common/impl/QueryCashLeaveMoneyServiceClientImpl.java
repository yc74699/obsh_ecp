...
public class QueryCashLeaveMoneyServiceClientImpl extends BaseClientServiceImpl implements IQueryCashLeaveMoneyService
{
	public QRY040040Result queryCashLeaveMoney(String phoneNum) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040040";
		...
		try
		{
			...
			if(__ret instanceof QRY040040Result)
			{
				__result = (QRY040040Result)__ret;
			}
			else
			{
				__result = new QRY040040Result();
