...
public class GetMultiNumsServiceClientImpl extends BaseClientServiceImpl
		implements IGetMultiNumsService {

	public QRY040052Result getMultiNums(String userCity, String subSid)
			throws LIException {
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040052";
		...
		try
		{
			...
			if(__ret instanceof QRY040052Result)
			{
				__result = (QRY040052Result)__ret;
			}
			else
			{
				__result = new QRY040052Result();
