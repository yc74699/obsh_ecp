...
public class GetQryaBankSubsInfoBankvtelServiceClientImpl implements
		IGetQryaBankSubsInfoBankvtel  {

	public QRY050069Result getQryaBankSubsInfoBankvtel(String phoneNum,
			String qryType) throws LIException {
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY050069";
		...
		try
		{
			...
			if(__ret instanceof QRY050069Result)
			{
				__result = (QRY050069Result)__ret;
			}
			else
			{
				__result = new QRY050069Result();
