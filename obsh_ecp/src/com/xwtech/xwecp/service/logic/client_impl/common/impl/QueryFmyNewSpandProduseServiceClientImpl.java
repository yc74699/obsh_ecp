...
public class QueryFmyNewSpandProduseServiceClientImpl extends BaseClientServiceImpl implements IQueryFmyNewSpandProduseService
{
	public QRY010023Result queryNewFmySpandProduse(String subSid, String cycle, Integer qryType, String qrysubsid) throws LIException
	{
		...
		try
		{
			...
			if(__ret instanceof QRY010023Result)
			{
				__result = (QRY010023Result)__ret;
			}
			else
			{
				__result = new QRY010023Result();
