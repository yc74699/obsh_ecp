...
public class QryMultiNumBlackListServiceClientImpl extends
		BaseClientServiceImpl implements IQryMultiNumBlackListService {

	public QRY040056Result qryMultiNumBlackList(String userCity,
			String userSid, String vnumSid) throws LIException {
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040056";
		...
		try
		{
			...
			if(__ret instanceof QRY040056Result)
			{
				__result = (QRY040056Result)__ret;
			}
			else
			{
				__ret = new QRY040056Result();
