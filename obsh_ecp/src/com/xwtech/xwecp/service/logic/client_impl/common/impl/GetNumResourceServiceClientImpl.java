...
public class GetNumResourceServiceClientImpl extends BaseClientServiceImpl implements IGetNumResourceService
{
	public QRY050015Result getNumResource(String city, String country) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY050015";
		...
		try
		{
			...
			if(__ret instanceof QRY050015Result)
			{
				__result = (QRY050015Result)__ret;
			}
			else
			{
				__result = new QRY050015Result();
