...
public class QueryRecommendBizNewServiceClientImpl extends BaseClientServiceImpl implements IQueryRecommendBizNewService
{
	public QRY060002Result queryRecommendBiz(String phoneNum, String actId, String isRecOrd, String isSplitChk,String channelId) throws LIException
	{
		...
		RequestParameter __param_isRecOrd = new RequestParameter("isRecOrd", isRecOrd);
		__requestData.getParams().add(__param_isRecOrd);
		RequestParameter __param_isSplitChk = new RequestParameter("isSplitChk", isSplitChk);
		__requestData.getParams().add(__param_isSplitChk);
