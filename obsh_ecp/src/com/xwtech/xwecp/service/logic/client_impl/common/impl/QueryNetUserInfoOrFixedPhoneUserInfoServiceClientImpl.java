...
public class QueryNetUserInfoOrFixedPhoneUserInfoServiceClientImpl extends BaseClientServiceImpl implements IQueryNetUserInfoOrFixedPhoneUserInfoService
{
	public QRY040021Result queryNetUserInfoOrFixedPhoneUserInfo(String phoneNum, String password, String city, String loginType) throws LIException
	{
		...
		RequestParameter __param_loginType = new RequestParameter("loginType", loginType);
		__requestData.getParams().add(__param_loginType);
		...
		try
		{
			...
			if(__ret instanceof QRY040021Result)
			{
				__result = (QRY040021Result)__ret;
			}
			else
			{
				__result = new QRY040021Result();
