...
public class QrygprsSectionfluxServiceClientImpl extends BaseClientServiceImpl implements
		IQrygprsSectionfluxService {

	public QRY040065Result qryGprsSectionFlux(String cycle)
			throws LIException {
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040065";
		...
		try
		{
			...
			if(__ret instanceof QRY040065Result)
			{
				__result = (QRY040065Result)__ret;
			}
			else
			{
				__result = new QRY040065Result();
