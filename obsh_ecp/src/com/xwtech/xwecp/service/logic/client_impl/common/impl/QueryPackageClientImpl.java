...
public class QueryPackageClientImpl extends BaseClientServiceImpl implements IQueryPackage
{
	public QRY050050Result findPackage(String msisdn, String mainProdId) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY050050";
		...
		try
		{
			...
			if(__ret instanceof QRY050050Result)
			{
				__result = (QRY050050Result)__ret;
			}
			else
			{
				__ret = new QRY050050Result();
