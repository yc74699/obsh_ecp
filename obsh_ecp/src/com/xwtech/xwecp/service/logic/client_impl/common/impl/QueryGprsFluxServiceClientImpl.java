...
public class QueryGprsFluxServiceClientImpl extends BaseClientServiceImpl
		implements IQueryGprsFluxService {

	public QRY040057Result queryGprsFlux(String userId, String cycle,
			String type) throws LIException {
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040057";
		...
		try
		{
			...
			if(__ret instanceof QRY040057Result)
			{
				__result = (QRY040057Result)__ret;
			}
			else
			{
				__result = new QRY040057Result();
