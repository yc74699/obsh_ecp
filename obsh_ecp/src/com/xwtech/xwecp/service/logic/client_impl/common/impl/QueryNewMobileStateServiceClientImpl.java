...
public class QueryNewMobileStateServiceClientImpl extends BaseClientServiceImpl implements IQueryNewMobileStateService
{
	public QRY090017Result queryNewMobileState(String mobile, String orderId, String type) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY090017";
		...
		try
		{
			...
			if(__ret instanceof QRY090017Result)
			{
				__result = (QRY090017Result)__ret;
			}
			else
			{
				__result = new QRY090017Result();
