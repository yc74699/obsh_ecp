 ...
 * 2014-06-11
 */
public class CfMyOrderQueryServiceClientImpl extends BaseClientServiceImpl implements ICfMyOrderQueryService
{
	public QRY010036Result cfmyorderquery(String orderid,String telnum) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY010036";
		...
		try
		{
			...
			if(__ret instanceof QRY010036Result)
			{
				__result = (QRY010036Result)__ret;
			}
			else
			{
				__result = new QRY010036Result();
