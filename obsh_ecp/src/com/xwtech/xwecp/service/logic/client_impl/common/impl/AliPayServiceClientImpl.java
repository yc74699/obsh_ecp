...
public class AliPayServiceClientImpl extends BaseClientServiceImpl implements IAliPayService
{
	public DEL040029Result aliPay(String phoneNum, String amount, String paymethod, String bankcode, int payFlag) throws LIException
	{
		...
		try
		{
			...
			{
				__result = (DEL040029Result)__ret;
			}
			else
			{
				__result = new DEL040029Result();
