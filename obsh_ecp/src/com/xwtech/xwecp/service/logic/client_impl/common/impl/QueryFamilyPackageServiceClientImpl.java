...
public class QueryFamilyPackageServiceClientImpl extends BaseClientServiceImpl implements IQueryFamilyPackageService
{
	public QRY020012Result queryFamilyPackage(String phoneNum, String extId, List<FamilyMember> memberMobileNum) throws LIException
	{
		...
		try
		{
			...
			if(__ret instanceof QRY020012Result)
			{
				__result = (QRY020012Result)__ret;
			}
			else
			{
				__result = new QRY020012Result();
