 ...
 * 2014 - 09 -24
 */
public class QueryYxfaLpbServiceClientImpl extends BaseClientServiceImpl implements IQueryYxfaLpbService
{
	public QRY070004Result queryYxfaLpb(String ddr_city, String marketingplan_plan_id,String prodid, String ischeck) throws LIException
	{
		...
		try
		{
			...
			if(__ret instanceof QRY070004Result)
			{
				__result = (QRY070004Result)__ret;
			}
			else
			{
				__result = new QRY070004Result();
