...
public class QueryGamePointServiceClientImpl extends BaseClientServiceImpl implements IQueryGamePointService
{
	public QRY050003Result queryGamePoint(String phoneNum, String beginDate, String endDate) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY050003";
		...
		try
		{
			...
			if(__ret instanceof QRY050003Result)
			{
				__result = (QRY050003Result)__ret;
			}
			else
			{
				__result = new QRY050003Result();
