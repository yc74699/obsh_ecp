...
public class SMSmsvbaScoreServiceClientImpl extends BaseClientServiceImpl implements ISMSmsvbaScoreService
{
	public DEL020004Result smsmsvbaScore(String msisdn, String number, String password, String amount) throws LIException
	{
		...
		try
		{
			...
			if(__ret instanceof DEL020004Result)
			{
				__result = (DEL020004Result)__ret;
			}
			else
			{
			__result = new DEL020004Result();
