 ...
 * 2014-03-27
 */
public class BlcseiQryRedPackServiceClientImpl extends BaseClientServiceImpl implements IBlcseiQryRedPackService
{
	public QRY010031Result blcseiQryRedPack(String msisdn, String userid,int opertype) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY010031";
		...
		try
		{
			...
			if(__ret instanceof QRY010031Result)
			{
				__result = (QRY010031Result)__ret;
			}
			else
			{
				__ret = new QRY010031Result();
