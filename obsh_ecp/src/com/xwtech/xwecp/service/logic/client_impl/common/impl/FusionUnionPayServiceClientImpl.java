...
public class FusionUnionPayServiceClientImpl extends BaseClientServiceImpl implements IFusionUnionPayService
{
	public DEL610038Result fusionUnionPay(String phoneNum, int payFlag, String amount,String unionPaySrl) throws LIException
	{
		...
		try
		{
			...
			if(__ret instanceof DEL610038Result)
			{
				__result = (DEL610038Result)__ret;
			}
			else
			{
				__result = new DEL610038Result();
