 ...
 * 20140724
 */
public class QueryGPSFluxInfoService20ClientImpl extends BaseClientServiceImpl
		implements IQueryGPSFluxInfo20Service {

	public QRY040084Result queryGPSFluxInfo20(String phoneNum,String cycle)
			throws LIException {
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040084";
		...
		try
		{
			...
			if(__ret instanceof QRY040084Result)
			{
				__result = (QRY040084Result)__ret;
			}
			else
			{
				__result = new QRY040084Result();
