...
public class CheckNetIntsallClientImpl extends BaseClientServiceImpl implements ICheckNetIntsall
{
	public QRY050048Result checkNetIntsall(String ddrCity, String userMsisdn) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY050048";
		...
		try
		{
			...
			if(__ret instanceof QRY050048Result)
			{
				__result = (QRY050048Result)__ret;
			}
			else
			{
				__result = new QRY050048Result();
