...
public class QueryMobileBroadBandClientImpl extends BaseClientServiceImpl implements IQueryMobileBroadBand
{
	public QRY050047Result queryBroadBandInfo(String ddrCity, String userMsisdn) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY050047";
		...
		try
		{
			...
			if(__ret instanceof QRY050047Result)
			{
				__result = (QRY050047Result)__ret;
			}
			else
			{
				__result = new QRY050047Result();
