...
public class GetProBusinessServiceClientImpl extends BaseClientServiceImpl implements IGetProBusinessService
{
	public QRY050017Result getProBusiness(String city, String proId) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY050017";
		...
		try
		{
			...
			if(__ret instanceof QRY050017Result)
			{
				__result = (QRY050017Result)__ret;
			}
			else
			{
				__result = new QRY050017Result();
