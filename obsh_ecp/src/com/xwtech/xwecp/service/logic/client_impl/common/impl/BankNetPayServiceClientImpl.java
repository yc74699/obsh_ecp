...
public class BankNetPayServiceClientImpl extends BaseClientServiceImpl implements IBankNetPayService
{
	public DEL040025Result bankNetPay(String phoneNum, String amount, String bankType) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "DEL040025";
		...
		RequestParameter __param_bankType = new RequestParameter("bankType", bankType);
		__requestData.getParams().add(__param_bankType);
		...
		try
		{
			...
			if(__ret instanceof DEL040025Result)
			{
				__result = (DEL040025Result)__ret;
			}
			else
			{
				__result = new DEL040025Result();
