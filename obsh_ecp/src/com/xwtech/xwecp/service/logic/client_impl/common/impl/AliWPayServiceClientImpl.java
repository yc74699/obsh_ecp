...
import com.xwtech.xwecp.service.logic.client_impl.common.IAliWPayService;
...
public class AliWPayServiceClientImpl extends BaseClientServiceImpl implements IAliWPayService
{
	public DEL040099Result wapAliPay(String phoneNum, String amount, String paymethod, String bankcode, int payFlag,String bossDate,String checkSrl) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "DEL040099";
		...
		RequestParameter __param_bossDate = new RequestParameter("bossDate", bossDate);
		__requestData.getParams().add(__param_bossDate);
		RequestParameter __param_checkSrl = new RequestParameter("checkSrl", checkSrl);
		__requestData.getParams().add(__param_checkSrl);
		...
		try
		{
			...
			if(__ret instanceof DEL040029Result)
			{
				__result = (DEL040099Result)__ret;
			}
			else
			{
				__result = new DEL040099Result();
