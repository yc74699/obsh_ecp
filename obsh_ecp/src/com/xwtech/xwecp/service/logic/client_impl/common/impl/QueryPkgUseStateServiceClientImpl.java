...
public class QueryPkgUseStateServiceClientImpl extends BaseClientServiceImpl implements IQueryPkgUseStateService
{
	public QRY020003Result queryPkgUseState(String phoneNum, int type, String pkgId) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY020003";
		...
		try
		{
			...
			if(__ret instanceof QRY020003Result)
			{
				__result = (QRY020003Result)__ret;
			}
			else
			{
				__ret = new QRY020003Result();
