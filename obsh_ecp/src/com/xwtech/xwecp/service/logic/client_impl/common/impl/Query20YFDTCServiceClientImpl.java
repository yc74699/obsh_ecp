...
public class Query20YFDTCServiceClientImpl extends BaseClientServiceImpl implements IQuery20YFDTCService
{
	public QRY040087Result query20YFDTC(String msisdn) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040087";
		...
		try
		{
			...
			if(__ret instanceof QRY040087Result)
			{
				__result = (QRY040087Result)__ret;
			}
			else
			{
				__result = new QRY040087Result();
