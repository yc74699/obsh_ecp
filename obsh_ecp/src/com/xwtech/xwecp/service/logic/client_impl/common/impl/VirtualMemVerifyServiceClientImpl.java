...
public class VirtualMemVerifyServiceClientImpl extends BaseClientServiceImpl
		implements IVirtualMemVerifyService
{

	/**
	 * V网成员维护预校验,请求报文
	 */
	public DEL610044Result virtualMemVerify(String familysubsid,List<MemberinfoIn> memberInfoIn) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "DEL610044";
		...
		try
		{
			...
			if(__ret instanceof DEL610044Result)
			{
				__result = (DEL610044Result)__ret;
			}
			else
			{
				__result = new DEL610044Result();
