...
public class QueryFamilyBillsServiceClientImpl extends BaseClientServiceImpl implements IQueryFamilyBillsService
{
	public QRY010011Result queryFamilyBills(int queryType, String queryMonth, String extId) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY010011";
		...
		try
		{
			...
			if(__ret instanceof QRY010011Result)
			{
				__result = (QRY010011Result)__ret;
			}
			else
			{
				__result = new QRY010011Result();
