...
public class QueryUserScoreServiceClientImpl extends BaseClientServiceImpl implements IQueryUserScoreService
{
	public QRY030002Result queryUserScore(String phoneNum, int type) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY030002";
		...
		try
		{
			...
			if(__ret instanceof QRY030002Result)
			{
				__result = (QRY030002Result)__ret;
			}
			else
			{
				__result = new QRY030002Result();
