...
public class QryGetBaseOrgInfoByTelnumServiceClientImpl  extends BaseClientServiceImpl implements IQryGetBaseOrgInfoByTelnumService {

	public QRY040093Result qryBaseOrgInfoByTelnum(String region, String telnum)
			throws LIException {
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040093";
		...
		try
		{
			...
			if(__ret instanceof QRY040093Result)
			{
				__result = (QRY040093Result)__ret;
			}
			else
			{
				__ret = new QRY040093Result();
