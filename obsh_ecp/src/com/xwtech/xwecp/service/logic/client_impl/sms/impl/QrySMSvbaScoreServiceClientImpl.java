...
public class QrySMSvbaScoreServiceClientImpl extends BaseClientServiceImpl implements IQrySMSvbaScoreService
{
	public QRY030013Result qrySMSvbaScore(String msisdn, String number) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY030013";
		...
		try
		{
			...
			if(__ret instanceof QRY030013Result)
			{
				__result = (QRY030013Result)__ret;
			}
			else
			{
			__result = new QRY030013Result();
