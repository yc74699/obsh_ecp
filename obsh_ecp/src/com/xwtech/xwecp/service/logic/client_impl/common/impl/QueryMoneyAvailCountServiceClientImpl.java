...
public class QueryMoneyAvailCountServiceClientImpl extends BaseClientServiceImpl implements IQueryMoneyAvailCountService
{
	public QRY040038Result queryMoneyAvailCount(String phoneNum, String amount) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040038";
		...
		try
		{
			...
			if(__ret instanceof QRY040038Result)
			{
				__result = (QRY040038Result)__ret;
			}
			else
			{
				__result = new QRY040038Result();
