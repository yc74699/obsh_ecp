...
public class CheckUserTransRegClientImpl extends BaseClientServiceImpl implements ICheckUserTransReg
{
	public QRY050040Result checkUserTransReg(String phoneNum, String fromCity, String toCity, String userId) throws LIException
	{
		...
		try
		{
			...
			if(__ret instanceof QRY050040Result)
			{
				__result = (QRY050040Result)__ret;
			}
			else
			{
				__result = new QRY050040Result();
