...
public class QueryFamilyProdServiceClientImpl extends BaseClientServiceImpl implements IQueryFamilyProdService
{
	public QRY200003Result queryFamilyProdService(String familysubsid) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY200003";
		...
		try
		{
			...
			if(__ret instanceof QRY200003Result)
			{
				__result = (QRY200003Result)__ret;
			}
			else
			{
				__result = new QRY200003Result();
