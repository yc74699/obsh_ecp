...
public class QueryTbankDetailServiceClientImpl  extends BaseClientServiceImpl implements IQueryTbankDetailService{
	...
	public QRY040083Result queryTbankDetail(String phoneNum,String oprType,String drawType, String beginDate, String endDate)throws LIException 
	{
		...
		try
		{
			...
			if(__ret instanceof QRY040083Result)
			{
				__result = (QRY040083Result)__ret;
			}
			else
			{
				__result = new QRY040083Result();
