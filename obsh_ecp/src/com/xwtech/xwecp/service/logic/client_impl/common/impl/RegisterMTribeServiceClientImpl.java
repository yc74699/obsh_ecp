...
public class RegisterMTribeServiceClientImpl extends BaseClientServiceImpl implements IRegisterMTribeService
{
	public DEL010002Result registerMTribe(String phoneNum, List<TransferTribe> tribeList) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "DEL010002";
		...
		RequestParameter __param_tribeList = new RequestParameter("tribeList", tribeList);
		__requestData.getParams().add(__param_tribeList);
		...
		try
		{
			...
			if(__ret instanceof DEL010002Result)
			{
				__result = (DEL010002Result)__ret;
			}
			else
			{
				__result = new DEL010002Result();
