...
public class CuserFundNewClientImpl extends BaseClientServiceImpl implements ICuserFundNew
{
	public DEL040105Result cuserFundNew(String cityId, String phoneNum, String amount,int isSendMsg) throws LIException
	{
		...
		//增加是否发短信标识
		RequestParameter __param_isSendMsg = new RequestParameter("isSendMsg", isSendMsg);
		__requestData.getParams().add(__param_isSendMsg);
		...
		try
		{
			...
			if(__ret instanceof DEL040105Result)
			{
				__result = (DEL040105Result)__ret;
			}
			else
			{
			__result = new DEL040105Result();
