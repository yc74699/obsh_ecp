...
public class QueryAgentSerialNumberServiceClientImpl extends BaseClientServiceImpl implements IQueryAgentSerialNumberService
{
	public QRY040017Result queryAgentSerialNumber(String phoneNum, String queryType, String startDate, String endDate) throws LIException
	{
		...
		try
		{
			...
			if(__ret instanceof QRY040017Result)
			{
				__result = (QRY040017Result)__ret;
			}
			else
			{
				__result = new QRY040017Result();
