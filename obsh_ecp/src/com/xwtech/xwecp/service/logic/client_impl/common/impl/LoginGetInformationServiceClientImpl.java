...
public class LoginGetInformationServiceClientImpl extends BaseClientServiceImpl
		implements ILoginGetInformationService {

	public QRY010028Result loginGetInformation(String userMsisdn, Long idType,
			String modeId, String startcycle, String endcycle,
			Integer billType, Integer billlType) throws LIException {
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY010028";
		...
		RequestParameter __param_phoneNum = new RequestParameter("phoneNum", userMsisdn);
		...
		try
		{
			...
			if(__ret instanceof QRY010028Result)
			{
				__result = (QRY010028Result)__ret;
			}
			else
			{
				__result = new QRY010028Result();
