...
public class CheckMobilePayNumServiceClientImpl extends BaseClientServiceImpl implements ICheckMobilePayNumService
{
	public DEL010007Result checkMobilePayNum(String phoneNum, String ddrCity) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "DEL010007";
		...
		try
		{
			...
			if(__ret instanceof DEL010007Result)
			{
				__result = (DEL010007Result)__ret;
			}
			else
			{
				__result = new DEL010007Result();
