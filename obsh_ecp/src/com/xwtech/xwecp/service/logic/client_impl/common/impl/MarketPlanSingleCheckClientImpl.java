...
public class MarketPlanSingleCheckClientImpl extends BaseClientServiceImpl implements IMarketPlanSingleCheck
{
	public QRY110003Result marketPlanSingleCheck(String planid, String subsid, String drawFlag, String rewardList, String goodsPackId, String busiPackId) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY110003";
		...
		try
		{
			...
			if(__ret instanceof QRY110003Result)
			{
				__result = (QRY110003Result)__ret;
			}
			else
			{
				__result = new QRY110003Result();
