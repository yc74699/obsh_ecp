...
public class QueryLableServiceClientImpl extends BaseClientServiceImpl implements IQueryLableService
{
	public QRY120001Result queryLableInfo(String phoneNum) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY120001";
		...
		try
		{
			...
			if(__ret instanceof QRY120001Result)
			{
				__result = (QRY120001Result)__ret;
			}
			else
			{
				__result = new QRY120001Result();
