...
public class QryVirtualFamilyServiceClientImpl extends BaseClientServiceImpl implements IQryVirtualFamilyService
{
	/**
	 * 用户查询归属V网信息
	 */
	public QRY610001Result qryVirtualFamily(String subsid, String pkgprodid) throws LIException
	{
		...
		try
		{
			...
			if(__ret instanceof QRY610001Result)
			{
				__result = (QRY610001Result)__ret;
			}
			else
			{
				__result = new QRY610001Result();
