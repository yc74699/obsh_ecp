 ...
 * 2015-04-22
 */
public class QueryFlowbalanceServiceClientImpl extends BaseClientServiceImpl implements IQueryFlowbalanceService
{
			...
			String  subjectid) throws LIException
	{
		...
		RequestParameter __param_subjectid = new RequestParameter("subjectid", subjectid);
		__requestData.getParams().add(__param_subjectid);		
		...
		try
		{
			...
			if(__ret instanceof QRY610049Result)
			{
				__result = (QRY610049Result)__ret;
			}
			else
			{
				__result = new QRY610049Result();
