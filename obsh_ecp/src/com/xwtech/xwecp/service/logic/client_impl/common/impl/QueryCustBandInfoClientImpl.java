...
public class QueryCustBandInfoClientImpl extends BaseClientServiceImpl implements IQueryCustBandInfo
{
	public QRY040035Result queryCustBandInfo(String msisdn) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040035";
		...
		try
		{
			...
			if(__ret instanceof QRY040035Result)
			{
				__result = (QRY040035Result)__ret;
			}
			else
			{
				__result = new QRY040035Result();
