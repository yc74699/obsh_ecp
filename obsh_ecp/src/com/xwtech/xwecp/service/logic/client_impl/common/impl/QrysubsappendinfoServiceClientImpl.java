 ...
 * YangXQ 2014-6-18
 */
public class QrysubsappendinfoServiceClientImpl extends BaseClientServiceImpl implements IQrysubsappendinfoService
{
	public QRY060076Result qrysubsappendinfo(String telnum) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY060076";
		...
		try
		{
			...
			if(__ret instanceof QRY060076Result)
			{
				__result = (QRY060076Result)__ret;
			}
			else
			{
				__result = new QRY060076Result();
