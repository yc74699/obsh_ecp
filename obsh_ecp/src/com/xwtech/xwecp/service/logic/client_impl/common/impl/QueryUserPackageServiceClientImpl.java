...
public class QueryUserPackageServiceClientImpl extends BaseClientServiceImpl implements IQueryUserPackageService
{
	public QRY050027Result queryUserPackageList(String phoneNum, String city) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY050027";
		...
		try
		{
			...
			if(__ret instanceof QRY050027Result)
			{
				__result = (QRY050027Result)__ret;
			}
			else
			{
				__result = new QRY050027Result();
