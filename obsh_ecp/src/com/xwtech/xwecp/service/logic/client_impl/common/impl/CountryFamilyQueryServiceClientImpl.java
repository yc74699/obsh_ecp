...
import com.xwtech.xwecp.service.logic.client_impl.common.ICountryFamilyQueryService;
import com.xwtech.xwecp.service.logic.pojo.QRY050061Result;

public class CountryFamilyQueryServiceClientImpl extends BaseClientServiceImpl implements ICountryFamilyQueryService
{
	public QRY050061Result countryFamilyQuery(String householder_phone, String master_id) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY050061";
		...
		try
		{
			...
			if(__ret instanceof QRY050061Result)
			{
				__result = (QRY050061Result)__ret;
			}
			else
			{
				__result = new QRY050061Result();
