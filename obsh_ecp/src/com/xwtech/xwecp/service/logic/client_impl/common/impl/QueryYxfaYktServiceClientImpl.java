...
public class QueryYxfaYktServiceClientImpl extends BaseClientServiceImpl implements IQueryYxfaYktService
{
	public QRY070006Result queryYxfaYkt(String ddr_city, String usermarketingbaseinfo_user_id) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY070006";
		...
		try
		{
			...
			if(__ret instanceof QRY070006Result)
			{
				__result = (QRY070006Result)__ret;
			}
			else
			{
				__result = new QRY070006Result();
