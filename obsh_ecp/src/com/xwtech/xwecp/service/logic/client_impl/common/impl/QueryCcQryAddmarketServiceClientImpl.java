 ...
 * 2015-04-15
 */
public class QueryCcQryAddmarketServiceClientImpl extends BaseClientServiceImpl implements IQueryCcQryAddmarketService
{
	public 	QRY060004Result queryCcQryAddmarket(
			String 	ddr_city,
			String 	servnumber,
			String 	actid,
			String 	privid,
			String 	channel)throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY060004";
		...
		RequestParameter __param_channel = new RequestParameter("channel", channel);
		...
		try
		{
			...
			if(__ret instanceof QRY060004Result)
			{
				__result = (QRY060004Result)__ret;
			}
			else
			{
				__result = new QRY060004Result();
