 ...
 *  2014-6-13
 */
public class Query4GPkgUsedInfoServiceClientImpl extends BaseClientServiceImpl implements IQuery4GPkgUsedInfoService
{
	public QRY040072Result query4GPkgUsedInfo(String phoneNum) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040072";
		...
		try
		{
			...
			if(__ret instanceof QRY040072Result)
			{
				__result = (QRY040072Result)__ret;
			}
			else
			{
			__result = new QRY040072Result();
