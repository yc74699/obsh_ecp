...
{
	public DEL010021Result preCheckBusi(String phoneNum, String businum, String operType,String serviceType) throws LIException
	{
		...
		RequestParameter __param_serviceType = new RequestParameter("serviceType", serviceType);
		__requestData.getParams().add(__param_serviceType);
	...
	public DEL010021Result preCheckBusi(String phoneNum, String businum,
			String operType) throws LIException {
		return preCheckBusi(phoneNum,businum,operType,"1");
	}
