...
public class VrNetBookServiceClientImpl extends BaseClientServiceImpl implements IvrNetBookService
{
	public DEL040024Result vrNetBookService(String phoneNum, String city, String cardPwd, String amount, String isMZone) throws LIException
	{
		...
		RequestParameter __param_cardPwd = new RequestParameter("cardPwd", cardPwd);
		__requestData.getParams().add(__param_cardPwd);
		RequestParameter __param_amount = new RequestParameter("amount", amount);
		__requestData.getParams().add(__param_amount);
		RequestParameter __param_isMZone = new RequestParameter("isMZone", isMZone);
		__requestData.getParams().add(__param_isMZone);
		...
		try
		{
			...
			if(__ret instanceof DEL040024Result)
			{
				__result = (DEL040024Result)__ret;
			}
			else
			{
				__result = new DEL040024Result();
