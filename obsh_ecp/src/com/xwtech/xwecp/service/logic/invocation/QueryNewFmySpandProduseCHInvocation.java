 ...
 * @author wanghuan
 */
public class QueryNewFmySpandProduseCHInvocation extends BaseInvocation implements ILogicalService {
	...
	public QueryNewFmySpandProduseCHInvocation() {
	...
	public BaseServiceInvocationResult executeService(String accessId, ServiceConfig config, List<RequestParameter> params) {
		QRY040114Result res = new QRY040114Result();
...
//						fmyProdCallInfo.setPhoneNum(elm.getChildText("servnumber")); //把手机号码加入对象
						...
						//增加 typeId
						fmyProdCallInfo.setTypeId(elm.getChildText("typeid")== null? "": elm.getChildText("typeid"));
	 ...
	 * @param xmlName - xml报文
	 */
	public void getErrInfo(QRY040114Result res, String resp_code, String xmlName) {
