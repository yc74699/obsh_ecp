 ...
 *
 */
public class QueryFluxHisInvocation extends BaseInvocation implements
		ILogicalService {
	...
	private String  TotalBossService= "cc_4gqrygprsallpkgflux_70";
		
	public QueryFluxHisInvocation()
	{
	...
	{
		QRY040071Result res = new QRY040071Result();
...
//			fhi.setPkgTotal(totalFlux);
	 ...
	 * @throws Exception
	 */
	private String queryGPRSUsed(String accessId, List<RequestParameter> params, QRY040071Result res)
	{
		String reqXml = "";
		String rspXml = "";
		Element root = null;
	 ...
	 * @throws Exception
	 */
	private void queryGPRSTotal(String accessId, List<RequestParameter> params, QRY040071Result res,FluxHisInfo fhi)
	{
		String reqXml = "";
		String rspXml = "";
		Element root = null;
	 ...
	 * @return Element
	 */
	private Element checkReturnXml(String rspXml,QRY040071Result res)
	{
