 ...
 * Apr 14, 2015
 */
public class QueryNewRealTimeBillingBossCHInvocation extends BaseInvocation implements ILogicalService {
	...
	public QueryNewRealTimeBillingBossCHInvocation() {
	...
	private QRY040108Result querySingleHouseholdbills(List<RequestParameter> params,String accessId)
	{
		...
		try {
			...
			if (null != rspXml && !"".equals(rspXml)) {
				...
				// 设置结果信息
				this.getErrInfo(res, resp_code, "ac_acqryrealtimebill_361_ch");
			...
			try {
				...
				if (null != rspXml && !"".equals(rspXml)) {
					...
					if (!BOSS_SUCCESS.equals(errCode)) {
						ErrorMapping errDt = this.wellFormedDAO.transBossErrCode("QRY040108", "cc_cgetusercust_69", errCode);
						if (null != errDt) {
