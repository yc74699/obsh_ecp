...
public class QueryPayHistoryFlagInvocation extends BaseInvocation implements ILogicalService {
	private static final Logger logger = Logger.getLogger(QueryPayHistoryFlagInvocation.class);
	 ...
	 * @throws Exception
	 */
	public QueryPayHistoryFlagInvocation() {
	...
	public BaseServiceInvocationResult executeService(String accessId, ServiceConfig config, List<RequestParameter> params) {
		QRY010042Result re = new QRY010042Result();
		String rspXml = "";
	...
	try {
			...
			if (null != rspXml && !"".equals(rspXml)) {
				...
				if (!"0000".equals(reCode)) {
					errDt = this.wellFormedDAO.transBossErrCode("QRY010042", "ac_agetacctbkseqjk_515", reCode);
					if (null != errDt) {
				...
				if (null != reCode && "0000".equals(reCode)) {
					Map m= this.wellFormedDAO.getChannelPayFlag();//*********新增的渠道******
