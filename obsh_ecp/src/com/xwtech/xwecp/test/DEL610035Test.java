...
import com.xwtech.xwecp.service.logic.client_impl.common.IFmyordersubmitService;
import com.xwtech.xwecp.service.logic.client_impl.common.IQueryBugGetStrService;
import com.xwtech.xwecp.service.logic.client_impl.common.impl.FmyordersubmitServiceClientImpl;
 ...
 * 2014-05-29
 */
public class DEL610035Test
{
	private static final Logger logger = Logger.getLogger(DEL610035Test.class);
...
//		props.put("platform.password", "jhr");
		...
		lic.setUserCity("12");
		lic.setUserMobile("13915170778");
		InvocationContext ic = new InvocationContext();
		ic.addContextParameter("login_msisdn", "13915170778");
...
//		QRY040067Result ree = coo.queryBugGetStr("13915170778", "12","","");
//		System.out.println("流水号"+ree.getBugGetStr());
		
		Map<Object,String>map=new HashMap<Object,String>();
		map.put("telnum", "13770492424");// 手机号码
		map.put("totalfee","2000");//  费用总额
...
//		map.put("taskoid",ree.getBugGetStr());// 在线支付唯一序号
		...
		map.put("fmyprodid", "2000003497");// 家庭增值产品(套餐种类)
		map.put("fmyeffecttype","1");// 产品生效方式
		
		map.put("virtualprod", "2000003497");// 19人家庭V网
...
//		pr=new ProductInfoSubmit("2000003058","2013000001","0","0");
		...
		propertyinfoList.add(pi);
		pi=new Propertyinfo("contactPhone","13770492424");//联系电话
		propertyinfoList.add(pi);
		pi=new Propertyinfo("appointDate","2014-12-15 00:00:00");//预约安装时间 格式：yyyymmdd，需限定3个月之内
		propertyinfoList.add(pi);
		...
		Fmymeminfo v1=new Fmymeminfo("18751446961","12","766");
...
//		fmymeminfoList = null;
		IFmyordersubmitService co = new FmyordersubmitServiceClientImpl();
		DEL610035Result re = co.myordersubmit(map, rwdinfoList,productionList,deviceinfoList,propertyinfoList,fmymeminfoList,vitualinfoList);
