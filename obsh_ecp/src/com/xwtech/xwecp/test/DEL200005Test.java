...
import com.xwtech.xwecp.service.logic.client_impl.common.impl.DropFamilyProdServiceClientImpl;
 ...
 *DEL200004
 */
public class DEL200005Test {
private static final Logger logger = Logger.getLogger(DEL200005Test.class);
	...
	public static void main(String[] args) throws Exception
	{
		...
		IDropFamilyProdService co = new DropFamilyProdServiceClientImpl();
		DEL200005Result re = co.dropFamilyProd("", "");
