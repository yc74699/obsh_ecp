...
import com.xwtech.xwecp.service.logic.client_impl.common.impl.B2BDistributeServiceClientImpl;
...
public class B2B003Test
{
	private static final Logger logger = Logger.getLogger(B2B003Test.class);
...
//		ic.addContextParameter("user_id", "1419200008195116");  //13813382424-1419200008195116,13913032424-1419200008195160
		...
		//QQTMS_3Y 
		IB2BDistributeService co = new B2BDistributeServiceClientImpl();
		...
		B2B003Result re = co.b2bDistribute(info);
		logger.info(" ====== 开始返回参数 ======");
		if (re != null)
		{
