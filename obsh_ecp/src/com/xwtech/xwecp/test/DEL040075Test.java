...
import com.xwtech.xwecp.service.logic.client_impl.common.impl.ChgAccsettleTypeServiceClientImpl;
import com.xwtech.xwecp.service.logic.pojo.DEL040075Result;

public class DEL040075Test
{
	private static final Logger logger = Logger.getLogger(DEL040075Test.class);
...
//		props.put("platform.url", "http://10.32.229.103:10004/obsh_ecp/xwecp.do");
		...
		IChgAccsettleTypeService co = new ChgAccsettleTypeServiceClientImpl();
		DEL040075Result re = co.chgAccsettleType("13813382424", "0004","CMCC_UPAY","","","","","","","","3");
		logger.info(" ====== 开始返回参数 ======");
		if (re != null)
		{
