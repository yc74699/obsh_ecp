...
import com.xwtech.xwecp.service.logic.client_impl.common.IChgRequiredPackageService;
import com.xwtech.xwecp.service.logic.client_impl.common.impl.ChgRequiredPackageServiceClientImpl;
import com.xwtech.xwecp.service.logic.pojo.DEL040071Result;

public class DEL040071Test
{
	private static final Logger logger = Logger.getLogger(DEL040071Test.class);
...
//		props.put("platform.url", "http://10.32.65.238:8081/sms_ecp/xwecp.do");
		...
		IChgRequiredPackageService co = new ChgRequiredPackageServiceClientImpl();
		DEL040071Result re = co.chgPackage("13813382424", "4G_FX_158","4G_FX_188");
		logger.info(" ====== 开始返回参数 ======");
		if (re != null)
		{
