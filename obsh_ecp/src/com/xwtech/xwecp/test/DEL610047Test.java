...
import com.xwtech.xwecp.service.logic.client_impl.common.IVirtualFamilyProdInstallService;
import com.xwtech.xwecp.service.logic.client_impl.common.impl.VirtualFamilyProdInstallClientService;
...
public class DEL610047Test
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		memberInfoIn.add(new MemberinfoIn("13770492424","1210200002956009","12","766"));
		IVirtualFamilyProdInstallService famInstall = new VirtualFamilyProdInstallClientService();
		//主号用户编号,增值包编码,增值产品编码,产品生效方式,新增副号成员列表
		DEL610047Result re = famInstall.virtualFamilyProdInstall("1208200011660016", "2012000007", "2000003715,1", "1", memberInfoIn);
		if(re != null)
		{
